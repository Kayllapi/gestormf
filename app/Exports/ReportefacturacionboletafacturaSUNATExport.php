...
class ReportefacturacionboletafacturaSUNATExport implements FromView, ShouldAutoSize
{
    ...
    {
        return view('layouts/backoffice/tienda/sistema/reportefacturacionboletafactura/tablaexcel_sunat',[
