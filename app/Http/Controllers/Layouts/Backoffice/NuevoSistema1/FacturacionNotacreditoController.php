...
class FacturacionNotacreditoController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        json_facturacionnotacredito($idtienda,$request->name_modulo);
        return view('layouts/backoffice/tienda/nuevosistema/facturacionnotacredito/index', [
            'tienda'                 => $tienda,
        ]);
    } 
    /**
    ...
    public function create(Request $request, $idtienda)
    {
        ...
        return view('layouts/backoffice/tienda/nuevosistema/facturacionnotacredito/create',[
            'tienda'        => $tienda,
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'detalle') {
            $facturacionnotacreditodetalles = DB::table('s_facturacionnotacreditodetalle')
              ...
              ->get();
            return view('layouts/backoffice/tienda/nuevosistema/facturacionnotacredito/detalle',[
                'tienda'                              => $tienda,
        ...
        elseif($request->input('view') == 'ticket') {
            return view('layouts/backoffice/tienda/nuevosistema/facturacionnotacredito/ticket',[
                'tienda'                   => $tienda,
                'facturacionnotacredito' => $facturacionnotacredito
            ]);
    ...
    public function update(Request $request, $idtienda, $id)
    {
        ...
        elseif($request->input('view') == 'enviarcorreo'){
              ...
              $pdf = PDF::loadView('layouts/backoffice/tienda/nuevosistema/facturacionnotacredito/ticketpdf',[
                  'tienda'                    => $tienda,
                  'facturacionnotacredito'    => $facturacionnotacredito,
              ...
              $a4pdf = PDF::loadView('layouts/backoffice/tienda/nuevosistema/facturacionnotacredito/a4pdf',[
                  'tienda' => $tienda,
                  'facturacionnotacredito' => $facturacionnotacredito,
                  'notacreditodetalle' => $notacreditodetalle,
                  'configuracion' => $configuracion,
