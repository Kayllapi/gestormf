...
class SubCategoriaController extends Controller
{
    public function index(Request $request,$idtienda)
    {
        ...
        json_subcategoria($idtienda,$request->name_modulo);  

        $tienda = DB::table('tienda')->whereId($idtienda)->first();
        return view('layouts/backoffice/tienda/nuevosistema/subcategoria/index',[
            'tienda' => $tienda,
        ]);
    }
    ...
    public function create(Request $request,$idtienda)
    {
        ...
        $categorias = DB::table('s_categoria')
            ...
            ->get();
        return view('layouts/backoffice/tienda/nuevosistema/subcategoria/create',[
            'tienda' => $tienda,
    ...
    public function store(Request $request, $idtienda)
    {
        ...
        if($request->input('view') == 'registrar') {
            ...
            $imagen = uploadfile('','',$request->file('imagen'),'/public/backoffice/tienda/'.$idtienda.'/nuevosistema/');
    ...
    public function edit(Request $request, $idtienda, $idcategoria)
    {
        ...
        if($request->input('view') == 'editar') {
            $categorias = DB::table('s_categoria')
                ...
                ->orderBy('s_categoria.id','desc')
                ->get();
            return view('layouts/backoffice/tienda/nuevosistema/subcategoria/edit',[
        ...
        elseif($request->input('view') == 'detalle') {
          return view('layouts/backoffice/tienda/nuevosistema/subcategoria/detalle',[
            's_categoria' => $s_categoria,
            'tienda' => $tienda
          ]);
        ...
        elseif($request->input('view') == 'eliminar') {
            return view('layouts/backoffice/tienda/nuevosistema/subcategoria/delete',[
                's_categoria' => $s_categoria,
                'tienda' => $tienda
            ]);
        }
    ...
    public function update(Request $request, $idtienda, $s_idcategoria)
    {
        ...
        if($request->input('view') == 'editar') {
            ...
            $imagen = uploadfile($s_categoria->imagen,$request->input('imagenant'),$request->file('imagen'),'/public/backoffice/tienda/'.$idtienda.'/nuevosistema/');
