...
class AsignacioncapitalController extends Controller
{
    ...
    public function create(Request $request,$idtienda)
    {
        ...
        if($request->view == 'registrar') {
            ...
            return view(sistema_view().'/asignacioncapital/create',[
                'tienda' => $tienda,
                'agencias' => $agencias,
                'bancos' => $bancos,
    ...
    public function store(Request $request, $idtienda)
    {
        ...
        elseif($request->input('view') == 'registrar_insert') {
            ...
            $asignacioncapital = DB::table('asignacioncapital')
                ->orderBy('asignacioncapital.codigo','desc')
                ->limit(1)
                ->first();
            $codigo = 1;
            ...
            DB::table('asignacioncapital')->insert([
                'fecharegistro' => now(),
                'codigoprefijo' => 'OK',
                'codigo' => $codigo,
    ...
    public function show(Request $request, $idtienda, $id)
    {
        if($id=='show_table'){
            ...
            if($request->input('fechainicio') != ''){
                $where[] = ['asignacioncapital.fecharegistro','>=',$request->fechainicio.' 00:00:00'];
            }
            ...
            $asignacioncapital = DB::table('asignacioncapital')
                ->join('credito_tipooperacion','credito_tipooperacion.id','asignacioncapital.idtipooperacion')
                ->leftJoin('credito_tipodestino','credito_tipodestino.id','asignacioncapital.idtipodestino')
                ->join('users as responsable','responsable.id','asignacioncapital.idresponsable')
                ->leftJoin('users as responsable_recfinal','responsable_recfinal.id','asignacioncapital.idresponsable_recfinal')
                ->join('tienda','tienda.id','asignacioncapital.idtienda')
                ->where('asignacioncapital.idestadoeliminado',1)
            ...
            if(count($asignacioncapital)==0){
              ...
              $html .= '
                <tr style="position: sticky;bottom: 0;">
                  <td colspan="5" style="background-color: #144081 !important;text-align:right;color:#fff !important;">Total (S/.)</td>
                  <td style="background-color: #144081 !important;text-align:right;color:#fff !important;">'.number_format($total_suma-$total_resta, 2, '.', '').'</td>
                  <td colspan="6" style="background-color: #144081 !important;text-align:right;color:#fff !important;"></td>
                </tr>'; 
            return array(
              'html' => $html
            );
        ...
        elseif($id=='show_saldocapitalasignado'){
            ...
            foreach($tiendas as $key => $value){
                ...
                $monto_suma = DB::table('asignacioncapital')
                    ...
                    ->where('asignacioncapital.idtienda',$value->id)
                    ->where('asignacioncapital.idresponsable_recfinal','<>',0)
                    //->where($where)
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        $asignacioncapital = DB::table('asignacioncapital')
                      ->where('asignacioncapital.id',$id)
                      ->select(
                          'asignacioncapital.*',
                      )
                      ->orderBy('asignacioncapital.id','desc')
                      ->first();
        ...
        if($request->input('view') == 'editar'){
              ...
              return view(sistema_view().'/asignacioncapital/edit',[
                  'tienda' => $tienda,
                  'agencias' => $agencias,
                  'bancos' => $bancos,
                  'tipooperacions' => $tipooperacions,
        ...
        return view(sistema_view().'/asignacioncapital/delete',[
          'tienda' => $tienda,
          'asignacioncapital' => $asignacioncapital,
          'usuarios' => $usuarios,
        ]);
        ...
        elseif($request->input('view') == 'valid_registro') {
            $usuarios = DB::table('users')
                ...
                ->get();
            return view(sistema_view().'/asignacioncapital/valid_registro',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
            ]);
        }
        elseif($request->input('view') == 'recepcionar') {
            ...
            $usuarios = DB::table('users')
                ...
                ->select('users.*','permiso.id as idpermiso','permiso.nombre as nombrepermiso')
                ->get();
            return view(sistema_view().'/asignacioncapital/recepcionar',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
                'asignacioncapital' => $asignacioncapital,
            ]);
            ...
            return view(sistema_view().'/asignacioncapital/exportar',[
                'tienda' => $tienda,
            ...
            $pdf = PDF::loadView(sistema_view().'/asignacioncapital/exportar_pdf',[
                'tienda' => $tienda,
                'asignacioncapital' => $asignacioncapital,
                'fechainicio' => $request->fechainicio,
                'fechafin' => $request->fechafin,
            ...
            $pdf = PDF::loadView(sistema_view().'/asignacioncapital/reporte_saldocapitalasignado_pdf',[
                'tienda' => $tienda,
                'asignacioncapital' => $asignacioncapital,
                'agencia' => $agencia,
            ]); 
            ...
            return view(sistema_view().'/asignacioncapital/voucher',[
              'tienda' => $tienda,
            ...
            $asignacioncapital = DB::table('asignacioncapital')
                ...
                ->join('permiso as permiso_responsable','permiso_responsable.id','asignacioncapital.idresponsable_permiso')
                ->leftJoin('users as responsable_recfinal','responsable_recfinal.id','asignacioncapital.idresponsable_recfinal')
                ...
                ->join('permiso as permiso_responsable_recfinal','permiso_responsable_recfinal.id','asignacioncapital.idresponsable_permiso_recfinal')
                ->where('asignacioncapital.id',$id)
                ->select(
                    'asignacioncapital.*',
                    'credito_tipooperacion.nombre as credito_tipooperacionnombre',
            ...
            $pdf = PDF::loadView(sistema_view().'/asignacioncapital/voucher_pdf',[
                'tienda' => $tienda,
                'asignacioncapital' => $asignacioncapital,
            ]); 
            $pdf->setPaper('A4');
        ...
        elseif($request->input('view') == 'validar') {
            ...
            $usuarios = DB::table('users')
                ...
                ->select('users.*','permiso.id as idpermiso','permiso.nombre as nombrepermiso')
                ->get();
            return view(sistema_view().'/asignacioncapital/validar',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
                'idasignacioncapital' => $id,
            ]);
...
//         $request->user()->authorizeRoles($request->path(),$idtienda);
      if( $request->input('view') == 'eliminar' ){
            ...
            DB::table('asignacioncapital')->whereId($id)->delete();
            return response()->json([
              'resultado' => 'CORRECTO',
