...
class ControlaperturaopecajaController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        if($request->input('view') == 'tabla'){
            ...
            return view(sistema_view().'/controlaperturaopecaja/tabla',[
              'tienda' => $tienda,
              'agencias' => $agencias,
            ]);
        }
        ...
        if($id == 'showtable'){
          ...
          foreach($tiendas as $value){
              ...
              $ret_reservacf_caja_total = DB::table('movimientointernodinero')
                  ...
                  ->where('movimientointernodinero.fecharegistro','>=',$request->fecha.' 00:00:00')
                  ->where('movimientointernodinero.fecharegistro','<=',$request->fecha.' 23:59:59')
                  ->where('movimientointernodinero.idtienda',$value->id)
                  ->first();
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'cierre') {
          ...
          $tiendas = DB::table('tienda')
            ...
            return view(sistema_view().'/controlaperturaopecaja/cierre',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
            ...
            return view(sistema_view().'/controlaperturaopecaja/reporte',[
                'tienda' => $tienda,
            ...
            $pdf = PDF::loadView(sistema_view().'/controlaperturaopecaja/reporte_pdf',[
                'tienda' => $tienda,
                'fecha_corte' => $request->fecha_corte_reporte,
