...
class CvmovimientointernodineroinstiController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        if($request->input('view') == 'tabla'){
            return view(sistema_view().'/cvmovimientointernodineroinsti/tabla', compact(
                'tienda',
                'apertura_caja',
                'arqueocaja',
                'validacionDiaria'
    ...
    public function create(Request $request,$idtienda)
    {
        ...
        if($request->view == 'registrar_retiro2') {
            ...
            $fuenteretiros= DB::table('credito_fuenteretiro')
              ...
              ->whereIn('id',[10])
              ->get();
            return view(sistema_view().'/cvmovimientointernodineroinsti/create_retiro2',[
                'tienda' => $tienda,
                'bancos' => $bancos,
        ...
        elseif($request->view == 'registrar_deposito2') {
            ...
            $fuenteretiros= DB::table('credito_fuenteretiro')
              ...
              ->whereIn('id',[5])
              ->get();
            return view(sistema_view().'/cvmovimientointernodineroinsti/create_deposito2',[
                'tienda' => $tienda,
                'bancos' => $bancos,
                'fuenteretiros' => $fuenteretiros,
            ]);
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'editar_retiro2'){
            ...
            $fuenteretiros= DB::table('credito_fuenteretiro')
              ...
              ->whereIn('id',[10])
              ->get();
            return view(sistema_view().'/cvmovimientointernodineroinsti/edit_retiro2',[
                'tienda' => $tienda,
                'bancos' => $bancos,
                'fuenteretiros' => $fuenteretiros,
        ...
        elseif($request->input('view') == 'eliminar_retiro2'){
            $usuarios = DB::table('users')
                ...
                ->get();
            return view(sistema_view().'/cvmovimientointernodineroinsti/delete_retiro2',[
              'tienda' => $tienda,
              'movimientointernodinero' => $movimientointernodinero,
              'usuarios' => $usuarios,
            ]);
        ...
        elseif($request->input('view') == 'editar_deposito2'){
            ...
            $fuenteretiros= DB::table('credito_fuenteretiro')
              ...
              ->whereIn('id',[5])
              ->get();
            return view(sistema_view().'/cvmovimientointernodineroinsti/edit_deposito2',[
                'tienda' => $tienda,
                'bancos' => $bancos,
                'fuenteretiros' => $fuenteretiros,
                'movimientointernodinero' => $movimientointernodinero,
        ...
        elseif($request->input('view') == 'eliminar_deposito2'){
            $usuarios = DB::table('users')
                ...
                ->select('users.*','permiso.nombre as nombrepermiso')
                ->get();
            return view(sistema_view().'/cvmovimientointernodineroinsti/delete_deposito2',[
              'tienda' => $tienda,
              'movimientointernodinero' => $movimientointernodinero,
              'usuarios' => $usuarios,
            ]);
        ...
        elseif($request->input('view') == 'valid_registro_retiro2') {
            ...
            $usuarios = DB::table('users')
                ...
                ->get();
            return view(sistema_view().'/cvmovimientointernodineroinsti/valid_registro_retiro2',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
            ]);
        }
        elseif($request->input('view') == 'valid_registro_deposito2') {
            ...
            $usuarios = DB::table('users')
                ...
                ->select('users.*','permiso.id as idpermiso','permiso.nombre as nombrepermiso')
                ->get();
            return view(sistema_view().'/cvmovimientointernodineroinsti/valid_registro_deposito2',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
        ...
        elseif($request->input('view') == 'valid_reporte') {
            $usuarios = DB::table('users')
                ...
                ->select('users.*','permiso.nombre as nombrepermiso')
                ->get();
            return view(sistema_view().'/cvmovimientointernodineroinsti/valid_reporte',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
            ]);
        }
        elseif($request->input('view') == 'exportar') {
            return view(sistema_view().'/cvmovimientointernodineroinsti/exportar',[
                'tienda' => $tienda,
        ...
        elseif($request->input('view') == 'exportar_pdf'){
            ...
            $pdf = PDF::loadView(sistema_view().'/cvmovimientointernodineroinsti/exportar_pdf',[
                'tienda' => $tienda,
                'fechainicio' => $request->fechainicio,
                'fechafin' => $request->fechafin,
