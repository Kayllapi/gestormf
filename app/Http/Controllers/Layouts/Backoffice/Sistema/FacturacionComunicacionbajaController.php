...
class FacturacionComunicacionbajaController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        return view(sistema_view().'/facturacioncomunicacionbaja/tabla',[
            'tienda' => $tienda,
        ]);
    }
    ...
    public function create(Request $request,$idtienda)
    {
        ...
        return view(sistema_view().'/facturacioncomunicacionbaja/create',[
            'tienda'        => $tienda,
            'agencias'      => $agencias
        ]);
    }
    ...
    public function store(Request $request, $idtienda)
    {
      ...
      if($request->input('view') == 'registrar') {
           ...
           $tienda = DB::table('tienda')
            ...
            // json_facturacioncomunicacionbaja($idtienda, Auth::user()->idsucursal, Auth::user()->id);            
      ...
      elseif ($request->input('view') == 'registrounico') {
         ...
         $rules    = [
          ...
          $this->validate($request,$rules,$messages);
          $this->validarFechaEmision($request->fechaemision);
         ...
         // RESUMEN DIARIO      
          ...
          DB::table('s_facturacioncomunicacionbajadetalle')->insert([
              ...
              'serie'                         => $factura->venta_serie,
              'correlativo'                   => $factura->venta_correlativo,
              'descripcionmotivobaja'         => $request->motivo,
              'idfacturacionboletafactura'    => $factura->id,
              'idfacturacionnotacredito'      => 0,
              'idagencia'                     => $factura->idagencia,
              'idtienda'                      => $factura->idtienda,
        ...
        $rules    = [
         ...
         // RESUMEN DIARIO      
          ...
          DB::table('s_facturacioncomunicacionbajadetalle')->insert([
              ...
              'serie'                         => $notadebito->notadebito_serie,
              'correlativo'                   => $notadebito->notadebito_correlativo,
              'descripcionmotivobaja'         => $request->motivo,
              'idfacturacionboletafactura'    => 0,
              'idfacturacionnotacredito'      => 0,
    ...
    public function validarFechaEmision($fechaemision)
    {
        $fecha_emision = explode(' ', $fechaemision);
        $fecha_emision = new DateTime($fecha_emision[0]);     
        $fecha_actual  = date("d-m-Y");
    ...
    public function show(Request $request, $idtienda, $id)
    {
        ...
        if($id=='show_table'){
            ...
            return response()->json([
                ...
                'recordsFiltered' => $facturacioncomunicacionbaja->total(),
                'data'            => $tabla,
            ]);
        }
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'detalle'){
            $facturacioncomunicacionbajadetalle = DB::table('s_facturacioncomunicacionbajadetalle')
                ...
                ->get();   
            return view(sistema_view().'/facturacioncomunicacionbaja/detalle',[
                'tienda'                      => $tienda,
        ...
        elseif($request->input('view') == 'ticket') {
          ...
          $ticket->ruc_emision = $facturacioncomunicacionbaja->emisor_ruc;
          $ticket->razonsocial_emisor = strtoupper($facturacioncomunicacionbaja->emisor_razonsocial);
          $ticket->logotipo = url('public/backoffice/tienda/'.$tienda->id.'/sistema/'.$facturacioncomunicacionbaja->agencialogo);
          $ticket->direccion_emisor = strtoupper($facturacioncomunicacionbaja->emisor_direccion);
          $ticket->ubigeo_emisor = strtoupper($facturacioncomunicacionbaja->emisor_distrito.' - '.$facturacioncomunicacionbaja->emisor_provincia.' - '.$facturacioncomunicacionbaja->emisor_departamento);
    
          $ticket->correlativo_documento = str_pad($facturacioncomunicacionbaja->comunicacionbaja_correlativo, 8, "0", STR_PAD_LEFT);
          
          $ticket->fechaemision = date_format(date_create($facturacioncomunicacionbaja->comunicacionbaja_fechacomunicacion),"d/m/Y h:i:s A");
          $ticket->fechageneracion = date_format(date_create($facturacioncomunicacionbaja->comunicacionbaja_fechageneracion),"d/m/Y h:i:s A");
          ...
          return view(sistema_view().'/facturacioncomunicacionbaja/comprobante',[
              'ticket'                              => $ticket,
              'facturacioncomunicacionbajadetalle'  => $facturacioncomunicacionbajadetalle
          ]);
//             return view(sistema_view().'/facturacioncomunicacionbaja/ticket',[
//                 'tienda' => $tienda,
//                 'facturacioncomunicacionbaja'       => $facturacioncomunicacionbaja
//             ]);
        }
...
//             $pdf = PDF::loadView(sistema_view().'/facturacioncomunicacionbaja/ticketpdf',[
//                 'tienda'                    => $tienda,
//                 'facturacioncomunicacionbaja'        => $facturacioncomunicacionbaja,
//                 'facturacioncomunicacionbajadetalle' => $facturacioncomunicacionbajadetalle,
//             ]);
