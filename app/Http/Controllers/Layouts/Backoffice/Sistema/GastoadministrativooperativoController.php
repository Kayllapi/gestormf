...
class GastoadministrativooperativoController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        if($request->input('view') == 'tabla'){
            return view(sistema_view().'/gastoadministrativooperativo/tabla',[
              'tienda' => $tienda
            ]);
        }
    ...
    public function create(Request $request,$idtienda)
    {
        ...
        if($request->view == 'registrar') {
            ...
            return view(sistema_view().'/gastoadministrativooperativo/create',[
                'tienda' => $tienda,
                'bancos' => $bancos,
    ...
    public function store(Request $request, $idtienda)
    {
        ...
        if($request->input('view') == 'registrar') {
            ...
            $gastoadministrativooperativo = DB::table('gastoadministrativooperativo')
                ->orderBy('gastoadministrativooperativo.codigo','desc')
                ->limit(1)
                ->first();
            $codigo = 1;
            ...
            DB::table('gastoadministrativooperativo')->insert([
                'fecharegistro' => now(),
                'codigoprefijo' => 'OG',
                'codigo' => $codigo,
                //'fechapago' => now(),
    ...
    public function show(Request $request, $idtienda, $id)
    {
        if($id=='show_table'){
            ...
            if($request->input('fechafin') != ''){
                $where[] = ['gastoadministrativooperativo.fechapago','<=',$request->fechafin.' 23:59:59']; 
            }
            ...
            $gastoadministrativooperativo = DB::table('gastoadministrativooperativo')
                ...
                ->orderBy('gastoadministrativooperativo.id','ASC')
                ->get();
          ...
          if(count($gastoadministrativooperativo)==0){
              ...
              $html .= '
                <tr style="position: sticky;bottom: -1px;z-index:1;">
                  <th style="text-align:center;" colspan="11">RESUMEN: &nbsp;&nbsp;&nbsp Total (S/.): '.number_format($total, 2, '.', '').' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    public function edit(Request $request, $idtienda, $id)
    {
      ...
      $gastoadministrativooperativo = DB::table('gastoadministrativooperativo')
                      ->where('gastoadministrativooperativo.id',$id)
                      ->select(
                          'gastoadministrativooperativo.*',
                      )
                      ->orderBy('gastoadministrativooperativo.id','desc')
                      ->first();
      ...
      if($request->input('view') == 'editar'){
        ...
        return view(sistema_view().'/gastoadministrativooperativo/edit',[
          'tienda' => $tienda,
      ...
      elseif($request->input('view') == 'eliminar'){
        ...
        return view(sistema_view().'/gastoadministrativooperativo/delete',[
          'tienda' => $tienda,
          'gastoadministrativooperativo' => $gastoadministrativooperativo,
          'usuarios' => $usuarios,
        ]);
            ...
            return view(sistema_view().'/gastoadministrativooperativo/exportar',[
                'tienda' => $tienda,
            ...
            $pdf = PDF::loadView(sistema_view().'/gastoadministrativooperativo/exportar_pdf',[
                'tienda' => $tienda,
                'gastoadministrativooperativo' => $gastoadministrativooperativo,
                'fechainicio' => $request->fechainicio,
                'fechafin' => $request->fechafin,
        ...
        elseif($request->input('view') == 'validar') {
            ...
            $usuarios = DB::table('users')
                ...
                ->get();
            return view(sistema_view().'/gastoadministrativooperativo/validar',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
