...
class IngresoextraordinarioController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        if($request->input('view') == 'tabla'){
            return view(sistema_view().'/ingresoextraordinario/tabla',[
              'tienda' => $tienda
            ]);
        }
    ...
    public function create(Request $request,$idtienda)
    {
        ...
        if($request->view == 'registrar') {
            ...
            return view(sistema_view().'/ingresoextraordinario/create',[
                'tienda' => $tienda,
                'bancos' => $bancos,
    ...
    public function show(Request $request, $idtienda, $id)
    {
        if($id=='show_table'){
            ...
            if($request->input('fechafin') != ''){
                $where[] = ['ingresoextraordinario.fechapago','<=',$request->fechafin.' 23:59:59']; 
            }
            ...
            $ingresoextraordinario = DB::table('ingresoextraordinario')
                ...
                ->orderBy('ingresoextraordinario.id','ASC')
                ->get();
    ...
    public function edit(Request $request, $idtienda, $id)
    {
      ...
      $ingresoextraordinario = DB::table('ingresoextraordinario')
                      ->where('ingresoextraordinario.id',$id)
                      ->select(
                          'ingresoextraordinario.*',
                      )
                      ->orderBy('ingresoextraordinario.id','desc')
                      ->first();
      ...
      if($request->input('view') == 'editar'){
        ...
        return view(sistema_view().'/ingresoextraordinario/edit',[
          'tienda' => $tienda,
      ...
      elseif($request->input('view') == 'eliminar'){
        ...
        return view(sistema_view().'/ingresoextraordinario/delete',[
          'tienda' => $tienda,
          'ingresoextraordinario' => $ingresoextraordinario,
          'usuarios' => $usuarios,
        ]);
            ...
            return view(sistema_view().'/ingresoextraordinario/exportar',[
                'tienda' => $tienda,
            ...
            $pdf = PDF::loadView(sistema_view().'/ingresoextraordinario/exportar_pdf',[
                'tienda' => $tienda,
                'ingresoextraordinario' => $ingresoextraordinario,
                'fechainicio' => $request->fechainicio,
                'fechafin' => $request->fechafin,
        ...
        elseif($request->input('view') == 'validar') {
            $usuarios = DB::table('users')
                ...
                ->get();
            return view(sistema_view().'/ingresoextraordinario/validar',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
