    ...
    public function show(Request $request, $idtienda, $id)
    {
        ...
        if($id == 'showtable'){
          ...
          foreach($credito_cobranzacuotas as $key => $value){
              ...
              //if($value->idmodalidad_credito==4){ $operacionen1 = 'REFINANCIADO'; }
          ...
          if(count($credito_cobranzacuotas)==0){
              ...
              $html .= '</tbody><tfoot class="table-dark" style="position: sticky;bottom: 0;">
                <tr>
                  ...
                  <td style="text-align:right">'.number_format($total_cuotapagado, 2, '.', '').'</td>
                  <td style="text-align:right">'.number_format($total_acuenta, 2, '.', '').'</td>
                  <td style="text-align:right">'.number_format($total_interes_compensatorio, 2, '.', '').'</td>
                  <td style="text-align:right">'.number_format($total_interes_moratorio, 2, '.', '').'</td>
                  <td style="text-align:right">'.number_format($total_custodia, 2, '.', '').'</td>
                  <td style="text-align:right">'.number_format($total_cuentaxcobrar, 2, '.', '').'</td>
