...
class RecepcionarasignacioncapitalController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        if($request->input('view') == 'tabla'){
            ...
            return view(sistema_view().'/recepcionarasignacioncapital/tabla',[
              'tienda' => $tienda
            ]);
        }
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'recepcionar') {
            ...
            $usuarios = DB::table('users')
                ...
                ->get();
            return view(sistema_view().'/recepcionarasignacioncapital/recepcionar',[
                'tienda' => $tienda,
                'usuarios' => $usuarios,
            ...
            return view(sistema_view().'/recepcionarasignacioncapital/voucher',[
              'tienda' => $tienda,
            ...
            $pdf = PDF::loadView(sistema_view().'/recepcionarasignacioncapital/voucher_pdf',[
                'tienda' => $tienda,
                'asignacioncapital' => $asignacioncapital,
            ]); 
            $pdf->setPaper('A4');
