...
class  ReportecompraController extends Controller
{
    public function index(Request $request,$idtienda)
    {
        ...
        if($request->input('view') == 'tabla'){
            return view('layouts/backoffice/tienda/nuevosistema/reporte/reportecompra/tabla',[
                'tienda' => $tienda,
            ]);
        }
    }
    ...
    public function show(Request $request, $idtienda, $id)
    {
        ...
        if ($id == 'showtablapdf') {
            ...
            elseif ($request->listarpor == 3) {
             ...
             $pdf = PDF::loadView('layouts/backoffice/tienda/nuevosistema/reporte/reportecompra/tablapdf',[
                'tienda'      => $tienda,
