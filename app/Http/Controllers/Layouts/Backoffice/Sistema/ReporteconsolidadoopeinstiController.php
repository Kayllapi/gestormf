...
class ReporteconsolidadoopeinstiController extends Controller
{
    public function index(Request $request,$idtienda)
    {
        ...
        if($request->input('view') == 'tabla'){
            ...
            return view(sistema_view().'/reporteconsolidadoopeinsti/tabla',[
                'tienda' => $tienda,
                'agencias' => $agencias,
            ]);
        }
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'pdf_reporte'){
          ...
          $data_actual = DB::table('arqueocaja')
              ...
              ->first();
          $pdf = PDF::loadView(sistema_view().'/reporteconsolidadoopeinsti/pdf_reporte',[
              'co_actual' => $co_actual,
