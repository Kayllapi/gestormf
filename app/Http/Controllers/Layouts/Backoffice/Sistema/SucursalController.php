    ...
    public function update(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'editar') {
            ...
            $rules = [
                ...
                'idubigeo' => 'required',   
                'direccion' => 'required',     
                'ticket_nombre' => 'required',       
                'ticket_direccion' => 'required',   
            ...
            $messages = [
                ...
                'direccion.required' => 'La "Dirección" es Obligatorio.',
                'idubigeo.required' => 'El "Ubicación (Ubigeo)" es Obligatorio.',
                'ticket_nombre.required' => 'El "Nombre" es Obligatorio.',
                'ticket_direccion.required' => 'La "Dirección" es Obligatorio.',
            ...
            DB::table('tienda')->whereId($request->idtienda)->update([
                ...
                'password_compraventa' => '',
                'idubigeo'           => $request->input('idubigeo'),
                'ticket_nombre'          => $request->input('ticket_nombre'),
                'ticket_direccion'          => $request->input('ticket_direccion'),
