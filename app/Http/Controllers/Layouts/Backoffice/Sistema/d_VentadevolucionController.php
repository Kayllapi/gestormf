...
class VentadevolucionController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
      ...
      if($request->input('view') == 'tabla'){
          return view(sistema_view().'/ventadevolucion/tabla',[
              'tienda' => $tienda,
          ]);
      }
    }
   ...
   public function create(Request $request, $idtienda)
    {
        ...
        if($request->view == 'registrar') { 
          $tienda = DB::table('tienda')->whereId($idtienda)->first();
             return view(sistema_view().'/ventadevolucion/create',[
               'tienda' => $tienda
          ]);
        }
    }
    ...
    //   json_ventadevolucion($idtienda,Auth::user()->idsucursal,Auth::user()->id);
    ...
    public function show(Request $request, $idtienda, $id)
    {
        if($id == 'show_table'){
            $ventadevolucion = DB::table('s_ventadevolucion')
                ...
                ->select(
                        's_ventadevolucion.*',
                        's_venta.db_iduserscliente as nombrecliente',
                        's_venta.db_idusersclienteidentificacion as identificacioncliente',
                        'moneda.nombre as nombremoneda',
                        'responsable.nombre as nombreresponsable',
                        // 'entrega.nombre as entreganombre',
                        's_venta.db_idtipocomprobante as comprobantenombre'
                    )
            ...
            return response()->json([
                ...
                'recordsFiltered' => $ventadevolucion->total(),
                'data'            => $tabla,
            ]);
        }else if($id == 'show_buscarventa'){
      ...
      $tienda = DB::table('tienda')->whereId($idtienda)->first();
       ...
       if($request->input('view') == 'detalle') {
         $ventadevoluciondetalles = DB::table('s_ventadevoluciondetalle')
              ...
              ->get();
         return view(sistema_view().'/ventadevolucion/detalle',[
            ...
            return view(sistema_view().'/ventadevolucion/ticket',[
                'tienda'          => $tienda,
                'ventadevolucion' => $ventadevolucion,
           ...
           $ventadevoluciondetalles = DB::table('s_ventadevoluciondetalle')
            ...
            $pdf = PDF::loadView(sistema_view().'/ventadevolucion/ticketpdf',[
                    'tienda'                   => $tienda,      
                    'ventadevolucion'          => $ventadevolucion,
                    'ventadevoluciondetalles'  =>$ventadevoluciondetalles,
         ...
         $ventadevoluciondetalles = DB::table('s_ventadevoluciondetalle')
            ...
            return view(sistema_view().'/ventadevolucion/anular',[
              'ventadevolucion'         => $ventadevolucion,
              'tienda'                  => $tienda,
              'ventadevoluciondetalles' =>$ventadevoluciondetalles,
            ]);
