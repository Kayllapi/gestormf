...
class CompraController extends Controller
{
    public function index(Request $request,$idtienda)
    {
        ...
        /*$s_compra = DB::table('s_compra')
            //->where('s_compra.idtienda',$idtienda)
            ->orderBy('s_compra.id','asc')
            ->get();
      
        foreach($s_compra as $value){
            $s_compradetalles = DB::table('s_compradetalle')
              ->where('s_compradetalle.s_idcompra',$value->id)
              ->orderBy('s_compradetalle.id','asc')
              ->get();
            foreach($s_compradetalles as $valuedetalle){
                DB::table('s_producto')->whereId($valuedetalle->s_idproducto)->update([
                    'fechavencimiento' => $valuedetalle->fechavencimiento
                ]);
            }
        }*/
        ...
        return view('layouts/backoffice/tienda/sistema/compra/index',[
            'tienda' => $tienda,
            's_compra' => $s_compra,
    ...
    public function create(Request $request, $idtienda)
    {
        ...
        return view('layouts/backoffice/tienda/sistema/compra/create',[
            'tienda' => $tienda,
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'editar') {
            ...
            $tipopersonas = DB::table('tipopersona')->get();
            $s_monedas = DB::table('s_moneda')->get();
            return view('layouts/backoffice/tienda/sistema/compra/edit',[
                'tienda' => $tienda,
                'comprobante' => $comprobante,
                'compra' => $compra,
            ...
            return view('layouts/backoffice/tienda/sistema/compra/detalle',[
                'tienda' => $tienda,
                'ubigeos' => $ubigeos,
                'agencia' => $agencia,
                'comprobante' => $comprobante,
        ...
        elseif($request->input('view') == 'anular') {
            ...
            $s_compradetalles = DB::table('s_compradetalle')
              ...
              ->get();
            $s_monedas = DB::table('s_moneda')->get();
            return view('layouts/backoffice/tienda/sistema/compra/anular',[
                'tienda' => $tienda,
                'ubigeos' => $ubigeos,
                'agencia' => $agencia,
                'comprobante' => $comprobante,
          ...
          return view('layouts/backoffice/tienda/sistema/compra/delete',[
            'tienda' => $tienda,
            'compra' => $compra
          ]);
        }
