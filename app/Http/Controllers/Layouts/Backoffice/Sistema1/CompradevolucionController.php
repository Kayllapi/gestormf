...
class CompradevolucionController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
      ...
      return view('layouts/backoffice/tienda/sistema/compradevolucion/index',[
              'tienda'            => $tienda,
    ...
    public function create(Request $request, $idtienda)
    {
        ...
        return view('layouts/backoffice/tienda/sistema/compradevolucion/create',[
            'tienda'      => $tienda
        ]);
    }
          ...
          $idcompra = DB::table('s_compradevolucion')->insertGetId([
            ...
            foreach ($post_produtos as $item_producto3){
                ...
                /*productosaldo_actualizar(
                    $idtienda,
                    $compradetalle->s_idproducto,
                    'DEVOLUCION COMPRA',
                    $cantidad,
                    $producto->por,
                    $producto->idunidadmedida,
                    $item_producto3->idcompradetalle
                );*/
            }
            return response()->json([
                  'resultado'  => 'CORRECTO',
    ...
    public function edit(Request $request, $idtienda, $id)
    {
      ...
      $tienda = DB::table('tienda')->whereId($idtienda)->first();
       ...
       if($request->input('view') == 'detalle') {
         ...
         return view('layouts/backoffice/tienda/sistema/compradevolucion/detalle',[
               'compradevolucion'         => $compradevolucion,
               'tienda'                   => $tienda,
          ...
          return view('layouts/backoffice/tienda/sistema/compradevolucion/ticket',[
                'tienda'           => $tienda,
                'compradevolucion' => $compradevolucion,
           ...
           $compradevoluciondetalles = DB::table('s_compradevoluciondetalle')
            ...
            $pdf = PDF::loadView('layouts/backoffice/tienda/sistema/compradevolucion/ticketpdf',[
                    'tienda'                    => $tienda,      
                    'compradevolucion'          => $compradevolucion,
                    'compradevoluciondetalles'  => $compradevoluciondetalles,
           ...
           $compradevoluciondetalles = DB::table('s_compradevoluciondetalle')
            ...
            return view('layouts/backoffice/tienda/sistema/compradevolucion/anular',[
              'compradevolucion'         => $compradevolucion,
              'tienda'                   => $tienda,
              'compradevoluciondetalles' => $compradevoluciondetalles,
            ]);
