...
class FacturacionBoletafacturaController extends Controller
{
    public function index(Request $request,$idtienda) 
    {
          ...
          /*$facturacionboletafactura = DB::table('s_facturacionboletafactura')
            ...
            ->get();
              ...
              foreach($facturacionboletafactura as $value){
                  $respuesta_sunat = DB::table('s_facturacionrespuesta')
                    ->where('s_idfacturacionboletafactura', $value->id)
                    ->orderBy('id', 'desc')
                    ->first();
                
                  if($respuesta_sunat!=''){
                  
                  DB::table('s_facturacionboletafactura')->whereId($value->id)->update([
                      'idfacturacionrespuesta' => $respuesta_sunat->id
                  ]);
                  }
              }
              dd('---');*/
        ...
        return view('layouts/backoffice/tienda/sistema/facturacionboletafactura/index', [
            'tienda'                   => $tienda,
    ...
    public function create(Request $request, $idtienda)
    {
        ...
        $agencias = DB::table('s_agencia')
                ...
                ->get();
        return view('layouts/backoffice/tienda/sistema/facturacionboletafactura/create',[
            'tienda'        => $tienda,
            'monedas'       => $monedas,
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'detalle') {
            $boletafacturadetalle     = DB::table('s_facturacionboletafacturadetalle')
                ...
                ->get();
            return view('layouts/backoffice/tienda/sistema/facturacionboletafactura/detalle',[
                'facturacionboletafactura'=> $facturacionboletafactura,
        ...
        elseif($request->input('view') == 'ticket') {
            return view('layouts/backoffice/tienda/sistema/facturacionboletafactura/ticket',[
                'tienda' => $tienda,
                'facturacionboletafactura'=> $facturacionboletafactura
            ]);
        }
        ...
        elseif($request->input('view') == 'delete') {
            return view('layouts/backoffice/tienda/sistema/facturacionboletafactura/delete',[
                'tienda' => $tienda,
                'facturacionboletafactura'=> $facturacionboletafactura
            ]);
        }
    ...
    public function destroy(Request $request, $idtienda, $id)
    {
        ...
        if($request->input('view') == 'eliminar') {
            ...
            DB::table('s_facturacionboletafactura')
                ->where('id',$id)
                ->where('idtienda',$idtienda)
                ->delete();
            DB::table('s_facturacionboletafacturadetalle')
                ->where('id',$id)
                ->where('idtienda',$idtienda)
                ->delete();
