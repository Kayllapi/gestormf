...
class FacturacionGuiaremisionController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        $guiaremision  = DB::table('s_facturacionguiaremision')
            ...
            ->join('s_sunat_motivotraslado', 's_sunat_motivotraslado.codigo', 's_facturacionguiaremision.envio_codigotraslado')
            ...
            ->paginate(10);
        return view('layouts/backoffice/tienda/sistema/facturacionguiaremision/index', [
            'tienda'                  => $tienda,
            'facturacionguiaremision' => $guiaremision,
    ...
    public function create(Request $request,$idtienda)
    {
        ...
        return view('layouts/backoffice/tienda/sistema/facturacionguiaremision/create',[
            'tienda'        => $tienda,
            'configuracion' => $configuracion,
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        elseif($request->input('view') == 'ticket') {
            return view('layouts/backoffice/tienda/sistema/facturacionguiaremision/ticket',[
                'tienda' => $tienda,
                'facturacionguiaremision'=> $facturacionguiaremision
            ]);
