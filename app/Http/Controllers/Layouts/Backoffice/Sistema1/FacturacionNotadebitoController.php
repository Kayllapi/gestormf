...
class FacturacionNotadebitoController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        $facturacionnotadebito = DB::table('s_facturacionnotadebito')
            ...
            ->paginate(10);
        return view('layouts/backoffice/tienda/sistema/facturacionnotadebito/index', [
            'tienda'                 => $tienda,
    ...
    public function create(Request $request, $idtienda)
    {
        ...
        return view('layouts/backoffice/tienda/sistema/facturacionnotadebito/create',[
            'tienda'        => $tienda,
            'agencias'      => $agencias
        ]);
    }
    ...
    public function edit(Request $request, $idtienda, $id)
    {
        ...
        elseif($request->input('view') == 'ticket') {
            return view('layouts/backoffice/tienda/sistema/facturacionnotadebito/ticket',[
                'tienda'                   => $tienda,
                'facturacionnotadebito' => $facturacionnotadebito
            ]);
        ...
        elseif($request->input('view') == 'a4pdf') {
            ...
            $pdf = PDF::loadView('layouts/backoffice/tienda/sistema/facturacionnotadebito/a4pdf',[
                'tienda' => $tienda,
                'facturacionnotadebito' => $facturacionnotadebito,
                'notadebitodetalle' => $facturacionnotadebitodetalles,
            ]);
