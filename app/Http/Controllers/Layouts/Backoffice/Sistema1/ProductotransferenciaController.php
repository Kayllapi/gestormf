...
class ProductotransferenciaController extends Controller
{
    ...
    public function index(Request $request,$idtienda)
    {
        ...
        $tienda = DB::table('tienda')->whereId($idtienda)->first();
         $productotransferencias = DB::table('s_productotransferencia')
            ...
            ->orWhere('tienda_origen.id',$idtienda)
            ->where('s_productotransferencia.idestado',1)
            ->orWhere('tienda_origen.id',$idtienda)
            ->where('s_productotransferencia.idestado',2)
            ->orWhere('tienda_destino.id',$idtienda)
            ->where('s_productotransferencia.idestado',1)
            ->orWhere('tienda_destino.id',$idtienda)
            ->where('s_productotransferencia.idestado',2)
            ->select(
        ...
        return view('layouts/backoffice/tienda/sistema/productotransferencia/index',[
            'tienda'                 => $tienda,
    ...
    public function create(Request $request,$idtienda)
    {
        ...
        return view('layouts/backoffice/tienda/sistema/productotransferencia/create',[
            'tienda'        => $tienda,
            'tiendas'       => $tiendas,
    ...
    public function edit(Request $request, $idtienda, $id)
    {
     ...
     // $configuracion = tienda_configuracion($idtienda);
       ...
       if($request->input('view') == 'detalle') {
          ...
          return view('layouts/backoffice/tienda/sistema/productotransferencia/detalle',[
             'tienda' => $tienda,
              'tiendas' => $tiendas,
        ...
        }else if($request->input('view') == 'edit') {
          ...
          return view('layouts/backoffice/tienda/sistema/productotransferencia/edit',[
              'tienda'                 => $tienda,
              'tiendas'                => $tiendas,
              'productotransferencia'  => $productotransferencia,
              'detalletransferencia'   => $detalletransferencia
          ...
          return view('layouts/backoffice/tienda/sistema/productotransferencia/rechazar',[
              'tienda'                => $tienda,
              'tiendas'               => $tiendas,
              'productotransferencia' => $productotransferencia,
              'detalletransferencia'  => $detalletransferencia
          ...
          return view('layouts/backoffice/tienda/sistema/productotransferencia/confirmar',[
             'tienda' => $tienda,
              'tiendas' => $tiendas,
              'productotransferencia' => $productotransferencia,
              'detalletransferencia' => $detalletransferencia
          ...
          return view('layouts/backoffice/tienda/sistema/productotransferencia/delete',[
             'tienda' => $tienda,
              'tiendas' => $tiendas,
              'productotransferencia' => $productotransferencia,
              'detalletransferencia' => $detalletransferencia
            ...
            return view('layouts/backoffice/tienda/sistema/productotransferencia/ticket',[
                'tienda' => $tienda,
                'productotransferencia' => $productotransferencia
        ...
        elseif($request->input('view') == 'ticketpdf') {
            ...
            $pdf = PDF::loadView('layouts/backoffice/tienda/sistema/productotransferencia/ticketpdf',[
                'tienda' => $tienda,
                'agencia' => $agencia,
