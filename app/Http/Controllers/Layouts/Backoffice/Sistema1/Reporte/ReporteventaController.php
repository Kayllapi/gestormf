...
class  ReporteventaController extends Controller
{
    public function index(Request $request,$idtienda)
    {
        ...
        return view('layouts/backoffice/tienda/sistema/reporte/reporteventa/index',[
            'tienda'        => $tienda,
        ]);
    }
    ...
    public function show(Request $request, $idtienda, $id)
    {
        ...
        if($id == 'showtablapdf') {
            ...
            elseif($request->input('listarpor')==3) {
              ...
              $ventas = DB::table('s_venta')
                    ...
                    ->select(
                        ...
                        DB::raw('CONCAT(responsableregistro.apellidos, ", ", responsableregistro.nombre) as vendedor'),
                    )
                    ->orderBy('responsableregistro.apellidos','asc')
                    ->distinct()
                    ->get();
            ...
            $pdf = PDF::loadView('layouts/backoffice/tienda/sistema/reporte/reporteventa/tablapdf',[
                'tienda' => $tienda,
                'ventas' => $ventas_tabla,
