(function (factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    $[_PLUGIN_].prototype = {
        ...
        getImgOnclick : function(){
          let _this_ = this  ,
              IMG  = this.container.find('img.waterfall-img').map(function(index, elem) {
                return elem.getAttribute("lazy-onclick");
              }) ;
              return this.filterImgItem(IMG)
        },
