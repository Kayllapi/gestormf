...
<div class="list-single-main-wrapper fl-wrap">
    <div class="breadcrumbs gradient-bg fl-wrap">
      <span>{{$cinepelicula->nombre}} / Editar Episodio</span>
  ...
  <div class="profile-edit-container">
    <div class="custom-form">
      <div class="row">
        <div class="col-md-6">
          <label>Título *</label>
          <input type="text" value="{{$cineepisodio->nombre}}" id="nombre">
          <label>Descripción</label>
          <textarea id="descripcion">{{$cineepisodio->descripcion}}</textarea>
        </div>
        <div class="col-md-6">
          <label>Url de Video *</label>
          <input type="text" value="{{$cineepisodio->urlvideo}}" id="urlvideo">
          <label>Duración de video (Minutos) *</label>
          <input type="number" value="{{$cineepisodio->duracionvideo}}" id="duracionvideo">
          <label>Orden *</label>
          <input type="number" value="{{$cineepisodio->orden}}" id="orden">
        </div>
      </div>
    </div>
    <div class="custom-form">
