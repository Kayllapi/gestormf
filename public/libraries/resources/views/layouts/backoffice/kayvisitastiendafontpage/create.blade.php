...
<div class="list-single-main-wrapper fl-wrap">
    <div class="breadcrumbs gradient-bg fl-wrap">
      <span>INVERTIR EN VISITAS PARA FONTPAGE</span>
...
<form class="js-validation-signin px-30" 
                          action="javascript:;" 
                          onsubmit="callback({
                            route: 'backoffice/kayvisitastiendafontpage',
                            method: 'POST',
                            data:{
                                view:'registrar'
                            }        
    ...
    <div class="profile-edit-container">
        <div class="custom-form">
          <div style="background-color: #3498db;padding: 10px;color: #fff;font-size: 20px;margin-bottom: 10px;">
            {{ $configkayvisitastienda->puntoskay }} KAY = {{ $configkayvisitastienda->cantidad }} Visitas
          </div>
          <div class="row">
              <div class="col-md-7">
                  <label>Tienda *</label>
