  ...
  table.width200,table.rwd_auto {border:1px solid #4db7fe;width:100%;margin:0 0 50px 0}
    ...
    <div class="profile-edit-container">
        ...
        <div class="custom-form">
          <form action="{{ url('backoffice/reportepagos') }}" method="GET">
          <div class="row">
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-4">
                  <label>Fecha Inicio</label>
                  <input type="date" name="fechainicio" value="{{ isset($_GET['fechainicio']) ? $_GET['fechainicio']:'2020-01-01' }}">
                </div>
                <div class="col-md-4">
                  <label>Fecha Fin</label>
                  <input type="date" name="fechafin" value="{{ isset($_GET['fechafin'])?$_GET['fechafin']:'' }}">
                </div>
                <div class="col-md-4">
                  <label>Realizar</label>
                  <button class="btn big-btn" style="cursor:pointer;" type="submit">Consultar</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <table class="table" id="tabla-contenido">
        ...
        <tbody>
          ...
          <tr>
            <td style="padding:1pc">{{ $value->nombre }}</td>
