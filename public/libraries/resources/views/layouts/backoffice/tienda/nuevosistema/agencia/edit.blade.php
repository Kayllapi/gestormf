<form @include('app.nuevosistema.submit',['method'=>'PUT','view'=>'editar','id'=>$s_agencia->id])>
              ...
              <div class="tab">
                  <div id="tab-empresa-0" class="tab-content" style="display: block;">
                      <div class="row">
                         <div class="col-md-6">
                            <label>Ruc *</label>
                            <input type="text" id="ruc" value="{{ $s_agencia->ruc }}"/>
                          ...
                          <div class="col-md-6">
                            ...
                            @if($s_agencia->facturacion_certificado!='')
                                <div class="mensaje-info" style="background-color:#3c4e64 !important;">
                                  ...
                                  <b>Descargar certificado actual: <a href="{{ url('public/backoffice/tienda/'.$tienda->id.'/sunat/produccion/certificado/'.$s_agencia->facturacion_certificado) }}" class="btn mx-btn-post" style="background-color: #08b451;font-size: 18px;margin-top: 10px;"  target="_blank">{{$s_agencia->facturacion_certificado}}</a></b> 
                                </div>
