                ...
                <div class="statistic-container fl-wrap">
                    @foreach($pisos as $valuepiso)
                        ...
                        $ambientes = DB::table('s_comida_ambiente')
                            ...
                            ->get();
                        ?>
                        <div class="cont_ambiente" id="cont_ambiente_{{$valuepiso->id}}" >
                        @foreach($ambientes as $valueambiente)
                            ...
                            @endif
                            <div class="cont_mesa" id="cont_mesa_{{$valueambiente->id}}" <?php echo (count($pisos)==1&&count($ambientes)==1)?'style="display: block;"':'style="display:none;"'?>>
                            <?php
                ...
                <div class="custom-form">
                    ...
                    <div class="quantity fl-wrap">
                        <div class="quantity-item">
                            ...
                            <input type="text" id="pedido_producto_cantidad" class="qty" min="1" step="1" value="1" style="padding-left: 0px;" onkeyup="total_ordenpedido()" onclick="total_ordenpedido()">
...
<script>
  ...
  function registrar_mesa(idpiso,idambiente,idmesa){
      ...
      callback({
          route: 'backoffice/tienda/sistema/{{ $tienda->id }}/comidaordenpedido',
          method: 'POST',
          data:{
              view: 'registrarmesa',
              idpiso : idpiso,
      ...
      function(resultado){
          ...
          $('#cont-mesa-mensaje').html('<div class="cont-confirm" style="margin-top: 15px;">'+
                           ...
                           '<div class="col-md-6"><button type="button" class="btn big-btn color-bg flat-btn" onclick="confirm_cerrar(\'#modal-agregarmesa\')" style="background-color: #31353d;width:100%;border: 0px;cursor: pointer;">'+
  ...
  function seleccionar_mesa(){
      ...
      $.ajax({
          url:"{{url('backoffice/tienda/sistema/'.$tienda->id.'/comidaordenpedido/show-seleccionarmesa')}}",
          type:'GET',
  ...
  function mesa_eliminar(){
      callback({
          route: 'backoffice/tienda/sistema/{{ $tienda->id }}/comidaordenpedido/'+$('#pedido_producto_idpedido').val(),
          method: 'DELETE',
  ...
  // calculando orden de pedido
    ...
    function mostrar_producto(idpedido,nombre='') {
      ...
      $.ajax({
          url:"{{url('backoffice/tienda/sistema/'.$tienda->id.'/comidaordenpedido/show-seleccionarproducto')}}",
          type:'GET',
          data:{
              idpedido : idpedido,
          },
    ...
    function producto_eliminar(idpedidodetalle){
      ...
      load("#carga-productos"); 
      callback({
          route: 'backoffice/tienda/sistema/{{ $tienda->id }}/comidaordenpedido/'+idpedidodetalle,
          method: 'DELETE',
          data:{
