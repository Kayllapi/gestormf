<div class="list-single-main-wrapper fl-wrap">
    <div class="breadcrumbs gradient-bg fl-wrap">
      <span>Eliminar Orden de Pedido</span>
...
<div id="mx-carga-ordenpedido">
  <div class="mensaje-warning">
    <i class="fa fa-warning"></i> Esta seguro Elimar el Orden de Pedido de la mesa <b>"{{ $ordenpedido->mesanombre }}"</b>!.
  </div>
  <form class="js-validation-signin px-30" 
    ...
    <div class="profile-edit-container">
      ...
      <div class="custom-form">
        <button type="submit" class="btn mx-btn-post">Eliminar Orden de Pedido</button>
      </div>
    </div>
  </form> 
</div>
...
@endforeach
function agregarproductoEliminar(codigo, nombre, cantidad, precio, total, idproducto) {
