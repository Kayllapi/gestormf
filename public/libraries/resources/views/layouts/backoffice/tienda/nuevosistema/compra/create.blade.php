            ...
            <div class="mx-modal-cuerpo" id="contenido-registrarproducto">
              <div id="mx-carga-registrarproducto">
                  ...
                  <form class="js-validation-signin px-30" action="javascript:;" 
                        onsubmit="callback({
                                              route: 'backoffice/tienda/nuevosistema/{{ $tienda->id }}/compra',
                                              method: 'POST',
...
function registrar_compra(){
    ...
    function(resultado){
         location.href = '{{ url('backoffice/tienda/nuevosistema/'.$tienda->id.'/compra') }}';                                                  
    })
}
...
function buscarcodigo(pthis){
    ...
    $.ajax({
        url:"{{url('backoffice/tienda/nuevosistema/'.$tienda->id.'/compra/showseleccionarproductocodigo')}}",
        type:'GET',
        data: {
