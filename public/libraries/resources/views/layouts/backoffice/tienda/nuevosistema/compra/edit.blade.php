...
function actualizar_compra(){
    callback({
        route: 'backoffice/tienda/nuevosistema/{{ $tienda->id }}/compra/{{ $compra->id }}',
        method: 'PUT',
        carga: '#carga-compra',
        data:{
            view: 'editar',
...
$("#idproveedor").select2({
    ajax: {
        url:"{{url('backoffice/tienda/nuevosistema/'.$tienda->id.'/compra/showlistarusuario')}}",
        dataType: 'json',
        delay: 250,
...
$("#idproducto").select2({
    ajax: {
        url:"{{url('backoffice/tienda/nuevosistema/'.$tienda->id.'/compra/showlistarproducto')}}",
        dataType: 'json',
        delay: 250,
        data: function (params) {
            return {
    ...
    $.ajax({
        url:"{{url('backoffice/tienda/nuevosistema/'.$tienda->id.'/compra/showseleccionarproducto')}}",
        type:'GET',
        data: {
