...
<div class="tabs-container" id="tab-menuconfiguracionprestamo">
    <ul class="tabs-menu">
        ...
        <li><a href="#tab-menuconfiguracionprestamo-4">Seguro Desgravamen</a></li>
        <li><a href="#tab-menuconfiguracionprestamo-5">Gastos Administrativos</a></li>
        <li><a href="#tab-menuconfiguracionprestamo-6">Moras</a></li>
    ...
    <div class="tab">
        <div id="tab-menuconfiguracionprestamo-0" class="tab-content" style="display: block;">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <input type="number" id="diagracia" step="0.01"
                           value="{{ $configuracion['diagracia']!=null?$configuracion['diagracia']:'0' }}">
        ...
        <div id="tab-menuconfiguracionprestamo-4" class="tab-content" style="display: none;">
        ...
        <div id="tab-menuconfiguracionprestamo-5" class="tab-content" style="display: none;">
          <div class="mensaje-info">
        ...
        <div id="tab-menuconfiguracionprestamo-6" class="tab-content" style="display: none;">
           <div class="mensaje-info">
