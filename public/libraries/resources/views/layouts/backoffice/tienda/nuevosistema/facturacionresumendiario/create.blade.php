    ...
    <div class="custom-form">
        ...
        <div id="cont-form-facturacionresumen" style="display:none;">
            <form class="js-validation-signin px-30" 
                  action="javascript:;" 
                  onsubmit="callback({
                    route: 'backoffice/tienda/nuevosistema/{{ $tienda->id }}/facturacionresumendiario',
                    method: 'POST',
                    data:{
                        view: 'registrar',
                    ...
                    function(resultado){
                        location.href = '{{ url('backoffice/tienda/nuevosistema/'.$tienda->id.'/facturacionresumendiario') }}';
                    },this)"> 
...
$("#idagencia").select2({
    ...
    $.ajax({
            url:"{{url('backoffice/tienda/nuevosistema/'.$tienda->id.'/facturacionresumendiario/show-selecionarserie')}}",
            type:'GET',
            data: {
...
function cargarventa_boletafactura(facturador_estado,idagencia,facturador_serie,facturador_correlativo){
    ...
    $.ajax({
        url:  "{{url('backoffice/tienda/nuevosistema/'.$tienda->id.'/facturacionresumendiario/show-seleccionarboletafactura')}}",
        type:'GET',
        data: {
            idagencia               : idagencia,
