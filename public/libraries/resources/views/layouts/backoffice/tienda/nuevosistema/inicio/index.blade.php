...
<div class="row">
  <div class="col-md-12">
    ...
    @if(isset($configuracion))
      @if($configuracion->imagensistema != '')
      <div class="list-single-main-media fl-wrap" style="margin-bottom: 5px;">
          <img  src="{{ url('public/backoffice/tienda/'.$tienda->id.'/imagensistema/'.$configuracion->imagensistema) }}" class="respimg" alt="">
      </div>
      @else
      <div class="list-single-main-media fl-wrap" style="margin-bottom: 5px;">
