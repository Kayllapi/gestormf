<div class="col-sm-6">
    <div class="tabs-container" id="tab-credito">
        <ul class="tabs-menu">
            ...
            <li><a href="#tab-credito-1">Crédito</a></li>
        </ul>
        <div class="tab">
    ...
    <button type="button" class="btn mx-btn-post" onclick="registrar_reprogramacion()" style="margin-bottom: 5px;">Registrar Reprogramación</button>
</div>  

<div class="col-sm-6">
    <div class="tabs-container" id="tab-tablerefinanciacion">
        <ul class="tabs-menu">
            <li class="current"><a href="#tab-tablerefinanciacion-0">Pendientes</a></li>
            <li><a href="#tab-tablerefinanciacion-1">Crédito</a></li>
        </ul>
        <div class="tab">
            <div id="tab-tablerefinanciacion-0" class="tab-content" style="display: block;">
                <div id="cont-cobranzapendiente"></div>
            </div>
            <div id="tab-tablerefinanciacion-1" class="tab-content" style="display: none;">
...
<script>
    ...
    tab({click:'#tab-tablerefinanciacion'});
    ...
    function registrar_reprogramacion() {
        callback({
