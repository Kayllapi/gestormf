...
<div id="carga-credito-laboral">
            ...
            <div id="tab-laboral-0" class="tab-content" style="display: block;">
                    <form action="javascript:;" 
                          id="form-credito-laboral"
                            ...
                            <input type="number" value="{{$prestamolaboral->ingresomensual}}" id="laboral_detalle_ingresomensual" min="0" step="0.1" disabled>
                            <label>Ubigeo</label>
    ...
    <button type="button" class="btn mx-btn-post" onclick="eliminar_laboral()">Eliminar Laboral</button>   
</div>           
...
$('#laboral_detalle_labora_desdemes').select2({
                ...
                singleMap('laboral_detalle',parseFloat({{$prestamolaboral->mapa_latitud}}),parseFloat({{$prestamolaboral->mapa_longitud}}),false);
  
  function eliminar_laboral(){
        $("#form-credito-laboral").submit();
    }
