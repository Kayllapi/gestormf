<form @include('app.nuevosistema.submit',[
      'method'  =>'PUT',
      'view'    =>'editar',
      'id'      =>$producto->id,
      'function'=> [
          'contenido' => 'seleccionartabla()',
          'descuento_seleccionarproductomaster' => ($configuracion['estadodescuento']==1?'descuento_seleccionarproductomaster()':'')
      ],
  ])>
                  ...
                  <div id="tab-producto-0" class="tab-content" style="display: block;">
                      <div class="row">
                         <div class="col-md-6">
                            ...
                            <input type="text" id="codigo" value="{{$producto->codigo}}" <?php echo $configuracion['estadodescuento']==1?'onkeyup="descuento_actualizar()"':'' ?>/>
                            <label>Nombre Producto *</label>
                            <input type="text" id="nombre" value="{{$producto->nombre}}" <?php echo $configuracion['estadodescuento']==1?'onkeyup="descuento_actualizar()"':'' ?>/>
                            <label>Precio Público *</label>
                            <input type="number" value="{{$producto->precioalpublico}}" id="precioalpublico" step="0.01" min="0" <?php echo $configuracion['estadodescuento']==1?'onclick="descuento_actualizartotal()" onkeyup="descuento_actualizar()"':'' ?>/>
                    ...
                    <div id="tab-producto-4" class="tab-content" style="display: none;">
                      <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" value="{{productosaldo($tienda->id,$producto->id)['stock']}} ({{productosaldo($tienda->id,$producto->id)['stock_restante']}})" id="stockactual" disabled/>
                                </div>
                            </div>
                            ...
                            <div id="cont-presentacion-producto" <?php echo $productomenor!=''?'':'style="display:none;"'?>>
                              ...
                              <div id="cont-agruparpresentacion">
                                  ...
                                  <div class="row">
                                      <div class="col-md-12">
                                          <input type="text" value="{{productosaldo($tienda->id,$productomenor->id)['stock']}} ({{productosaldo($tienda->id,$productomenor->id)['stock_restante']}})" id="stockactualagrupar" disabled/>
                                      </div>
                                  </div>
                              </div>
                              @else
                        ...
                        <div class="col-md-6">
                            ...
                            $htmlstock = '<table class="table" style="margin-bottom: 10px;">
                                <thead class="thead-dark">
                                  <tr>
                                    ...
                                    <th style="height: 30px;padding-top: 0;padding-bottom: 0;" width="10px">Restante</th>
                                  </tr>
                                </thead>
                                <tbody>';
                            foreach($presentaciones as $value){
                                ...
                                $htmlstock = $htmlstock.'<tr>
                                        ...
                                        <th style="'.$style.'text-align: center;border-right: 0px solid #000;">'.$value['cantidad_restante'].'</th>
                                      </tr>';
                            }
