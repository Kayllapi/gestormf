...
<div class="list-single-main-wrapper fl-wrap">
    <div class="breadcrumbs gradient-bg fl-wrap">
      <span>Reporte de Compra de Devolución</span>
    </div>
</div>
<form action="{{ url('backoffice/tienda/sistema/'.$tienda->id.'/reportecompradevolucion') }}" method="GET"> 
...
{{ $compradevoluciondetalle->links('app.tablepagination', ['results' => $compradevoluciondetalle]) }}
@endsection
@section('subscripts')
<script>
     function reporte(tipo){
        window.location.href = '{{url('backoffice/tienda/sistema/'.$tienda->id.'/reportecompradevolucion')}}?'+
                                'tipo='+tipo+
