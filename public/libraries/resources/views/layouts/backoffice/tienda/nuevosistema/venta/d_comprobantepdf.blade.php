...
<body>
	...
	<table class="table-sinborde">
		<tr>
			<td rowspan="3" style="padding:0px;text-align: center;width:400px;">
						<?php
			...
			<td style="white-space: nowrap;text-align: right;width: 300px;font-size: 15px;">{{ $agencia->nombrecomercial }}</td>
		</tr>
		<tr>
	...
	<table class="table-sinborde">
		<tr>
			...
			<td style="white-space: nowrap;text-align: right;width: 250px;font-size: 15px;">{{ $tienda->nombre }}</td>
		</tr>
		<tr>
			<td style="white-space: nowrap;text-align: right;font-size: 12px;">{{ $tienda->direccion }}</td>
		</tr>
	</table>
  @endif
	<br>
