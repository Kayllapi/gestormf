              ...
              <div class="tab">
                  ...
                  <div id="tab-carritocompra-2" class="tab-content" style="display: none;">
                      ...
                      <div class="mensaje-warning">
                        <i class="fa fa-warning"></i> Esta seguro de Eliminar la Venta</b>!.
                      </div>
                      <a href="javascript:;" onclick="eliminar_venta()" id="cont-btnventa" class="btn  big-btn  color-bg flat-btn mx-realizar-pago" style="float: left;width: 100%;">
                          Eliminar la Venta
                      </a>
<style>
#singleMap {
