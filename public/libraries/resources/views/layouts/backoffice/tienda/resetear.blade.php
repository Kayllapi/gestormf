    ...
    <div class="custom-form">
        <form action="javascript:;" 
              ...
              <div class="row">
                  ...
                  <div class="col-md-4">
                    <label style="text-align: center;">Escribe "RESETEAR" *</label>
                    <input type="text" id="validardato" style="text-align: center;"/>
                  </div>
              </div>
              <div class="mensaje-danger">
                ¿Esta Seguro de Resetear la Tienda <b>"{{ $tienda->nombre }}"</b>?
              </div>
              <button type="submit" class="btn color-bg flat-btn" style="width:100%;">Resetear</button>
        </form> 
    </div>
</div>
@endsection