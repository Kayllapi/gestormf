...
<form action="javascript:;" 
      onsubmit="callback({
        route: 'backoffice/tienda/sistema/{{ $tienda->id }}/configuracion/{{ $configuracion['idcomercio'] }}',
        method: 'PUT',
        data:{
            view: 'config_comercio'
        }
    },
    function(resultado){
        location.reload();                                                                           
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
                ...
                <select id="estadopreciounitario">
                    <option></option>
                    <option value="1">Habilitado</option>
                    <option value="2">Desabilitado</option>
                </select>
...
<script>
    ...
    @if($configuracion['estadopreciounitario']!=null)
        $("#estadopreciounitario").select2({
            placeholder: "--  Seleccionar --",
            minimumResultsForSearch: -1,
        }).val({{ $configuracion['estadopreciounitario'] }}).trigger("change");   
    @else
        $("#estadopreciounitario").select2({
            placeholder: "--  Seleccionar --",
            minimumResultsForSearch: -1,
