...
<body>
  <div class="contenedor">
     ...
     <tr>
      ...
      <tr>
          ...
          {{ $facturacionnotacredito->notacredito_montoimpuestoventa }}
			...
			<tr>
				<td colspan="3" style="text-align: center;height:5px;">{{ $facturacionnotacredito->leyenda_value }}</td>
			</tr>
			<tr>
				<td colspan="3" style="text-align: center;height:5px;"><div style="border-top: 1px dashed #31353d;width:100%;"></div></td>
			</tr>
	...
	<div class="qr">
    <img src="<?php echo $facturacionnotacredito->respuestaqr ?>" width="100px"><br>
	</div>
