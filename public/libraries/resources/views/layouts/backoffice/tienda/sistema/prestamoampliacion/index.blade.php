...
<div class="list-single-main-wrapper fl-wrap">
  <div class="breadcrumbs gradient-bg fl-wrap">
    <span>Solicitudes de Ampliaciones</span>
    <a class="btn btn-warning" href="{{ url('backoffice/tienda/sistema/'.$tienda->id.'/prestamoampliacion/create') }}"><i class="fa fa-angle-right"></i> Registrar</a>
  </div>
</div>
...
<div class="table-responsive">
          <table class="table" id="tabla-contenido">
              ...
              @include('app.tablesearch',[
                  ...
                  'search_url'=> url('backoffice/tienda/sistema/'.$tienda->id.'/prestamoampliacion')
              ])
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="header-user-menu menu-option" id="menu-opcion">
                          ...
                          <ul>
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamoampliacion/{{$value->id}}/edit?view=detalle"><i class="fa fa-list"></i> Detalle</a></li>
                          </ul>
                      </div>
                    </td>
                  </tr>
