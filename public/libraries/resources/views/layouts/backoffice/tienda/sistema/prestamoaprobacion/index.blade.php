...
@include('app.sistema.cabecera',[
    'nombre' => 'Aprobaciones de Crédito'
])
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="header-user-menu menu-option" id="menu-opcion">
                          ...
                          @if($value->idestadocredito==2)
                            @if($value->idestado==1)
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamoaprobacion/{{$value->id}}/edit?view=aprobar"><i class="fa fa-check"></i> Revisar Crédito</a></li>
                            @elseif($value->idestado==3)
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamoaprobacion/{{$value->id}}/edit?view=detalle"><i class="fa fa-list"></i> Detalle</a></li>
                            @endif
                          @elseif($value->idestadocredito==3)
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamoaprobacion/{{$value->id}}/edit?view=detalle"><i class="fa fa-list"></i> Detalle</a></li>
                          @elseif($value->idestadocredito==4)
