...
<div class="list-single-main-wrapper fl-wrap">
    <div class="breadcrumbs gradient-bg fl-wrap">
      <span>Rechazar Solicitud de Descuento de Mora</span>
    ...
    <form action="javascript:;" 
          onsubmit="callback({
            ...
            <div class="mensaje-warning">
                <b>¿Esta seguro de Rechazar la Mora?</b><br>          
            </div>
            <button type="submit" class="btn mx-btn-post" style="margin-bottom: 5px;"><i class="fa fa-ban"></i> Rechazar</button>
    </form>
</div>
<style>
