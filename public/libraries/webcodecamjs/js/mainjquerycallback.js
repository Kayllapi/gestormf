 ...
 */
function webcodecamcallback(param={},callback) {
  (function(undefined) {
    if(param['play']==undefined){
        param['play'] = '#webcodecam_play';
    }
    if(param['stop']==undefined){
        param['stop'] = '#webcodecam_stop';
    }
    if(param['contenedor']==undefined){
        param['contenedor'] = '#webcodecam_contenedor';
    }
    if(param['contenedorOcultar']==undefined){
        param['contenedorOcultar'] = '#webcodecam_contenedor_ocultar';
    }
    if(param['canvas']==undefined){
        param['canvas'] = '#webcodecam_canvas';
    }
    var scannerLaser = $(".scanner-laser"),
        ...
        contenedor = $(param['contenedor']),
        contenedorOcultar = $(param['contenedorOcultar']),
        canvas = $(param['canvas']);
    var args = {
    ...
    decoder.buildSelectMenu("#camera-select", 3).init();
