...
<script>
    ...
    $('{{$cont_efectivo}}').on('keyup',function() {
            formapago_contado_calcular();
    });
  
    function formapago(){
        $('body').append('<div class="main-register-wrap modal-ventaformapago" id="modal-ventaformapago">'+
              ...
              '<div class="main-register-holder" style="margin: 10px auto 50px;">'+
                  '<div class="main-register fl-wrap">'+
                      ...
                      '<div class="mx-modal-cuerpo">'+
                          ...
                          '</table>'+
                          '</div>'+
                          '<div id="cont-formapago-venta" style="display:none;">'+
                          '<button type="submit" class="btn mx-btn-post">Realizar Venta</button>'+
                          '</div>'+
                          '</div>'+
                      '</div>'+
                  '</div>'+
    ...
    function formapago_contado_calcular(){
        var totalefectivo = parseFloat($('{{$cont_efectivo}}').val());
        var totaldeposito = 0;
    ...
    function formapago_credito_actualizar(){
        var total = parseFloat($("{{$cont_efectivo}}").val());
    ...
    function formapago_credito_selecionar(){
        var data = '';
        $("#tabla-formapago > tbody > tr").each(function() {
            var num = $(this).attr('id');        
...
<style>
  #tabla-tipopago .error-input {
      margin-top: 0px !important;
      float: inherit !important;
  }
  #tabla-tipopago input[type="time"] {
