                ...
                <div style="font-family: Courier;font-weight: bold;font-size: 12px;width: 100%;text-align: center;color: #000;margin-top:20px;">
                      ...
                      <div style="text-align: left;color: #000;">   
                        @if($facturacionboletafactura->venta_tipodocumento==3)
                           BOLETA ELECTRÓNICA: {{$facturacionboletafactura->venta_serie}}-{{ str_pad($facturacionboletafactura->id, 8, "0", STR_PAD_LEFT) }}
                        @elseif($facturacionboletafactura->venta_tipodocumento==1)
                           FACTURA ELECTRÓNICA: {{$facturacionboletafactura->venta_serie}}-{{ str_pad($facturacionboletafactura->id, 8, "0", STR_PAD_LEFT) }}
                        @endif<br>
                        FECHA: {{ date_format(date_create($facturacionboletafactura->venta_fechaemision),"d/m/Y h:i:s A") }}<br>
                        ...
                        VENDEDOR: {{ strtoupper($facturacionboletafactura->responsablenombre) }}<br>
                    </div>
                    ...
                    <tbody>
                     ...
                     <tr>
                      ...
                      <tr>
                        <td colspan="3" style="text-align: center;height:5px;font-family: Courier;color: #000;">{{ $facturacionboletafactura->leyenda_value }}</td>
                      </tr>
                      <tr>
                        <td colspan="3" style="text-align: center;height:5px;font-family: Courier;color: #000;"><div style="border-top: 1px dashed #31353d;width:100%;"></div></td>
                      </tr>
