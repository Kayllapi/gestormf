...
?>
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="tabs-container" id="tab-detalledeldia">aaaaaaaaaaa
                @if($aperturacierre->config_sistema_moneda_usar==1)
                @elseif($aperturacierre->config_sistema_moneda_usar==2)
                @else
                <ul class="tabs-menu">
                ...
                <div class="tab">
                    ...
                    <div id="tab-detalledeldia-1" class="tab-content" style="display: block;">
                        ...
                        <div class="accordion">
                                  ...
                                  <table class="table" id="tabla-contenido">
                                      ...
                                      <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>{{ $value->cliente }}</td>
                                            <td>{{ $value->monto }}</td>
                                            <td>{{ $value->fechaanuladodesembolso }}</td>
                                          </tr>
                                          @endforeach
                                      </tbody>
                                  </table>
                                  ...
                                  <table class="table" id="tabla-contenido">
                                      ...
                                      <tbody>
                                          ...
                                          <tr>
                                            <td style="height: 40px;">{{ str_pad($value->codigo, 8, "0", STR_PAD_LEFT) }}</td>
                                            <td>{{ $value->cliente }}</td>
                                            <td>{{ number_format($value->facturacion_montorecibido-$value->facturacion_vuelto, 2, '.', '') }}</td>
                            ...
                            @endif
                            @if($fectivo_soles['total_ahorro_recaudaciones']>0)
                            <a class="toggle" href="#"> Recaudaciones ({{ $fectivo_soles['total_ahorro_recaudaciones'] }})<i class="fa fa-angle-down"></i></a>
                            <div class="accordion-inner">
                               <div class="table-responsive">
                                  <table class="table" id="tabla-contenido">
                                      <thead class="thead-dark">
                                      ...
                                      <tbody>
                                          @foreach($fectivo_soles['ahorro_recaudaciones'] as $value)
                                          <tr>
                                            <td style="height: 40px;">{{ str_pad($value->codigo, 8, "0", STR_PAD_LEFT) }}</td>
                                            <td>{{ $value->cliente }}</td>
                                            <td>
                            ...
                            @endif
                            @if($fectivo_soles['total_ahorro_retiros']>0)
                            <a class="toggle" href="#"> Retiros ({{ $fectivo_soles['total_ahorro_retiros'] }})<i class="fa fa-angle-down"></i></a>
                            <div class="accordion-inner">
                               <div class="table-responsive">
                                  <table class="table" id="tabla-contenido">
                                      <thead class="thead-dark">
                                      ...
                                      <tbody>
                                          @foreach($fectivo_soles['ahorro_retiros'] as $value)
                                          <tr>
                                            <td style="height: 40px;">{{ str_pad($value->codigo, 8, "0", STR_PAD_LEFT) }}</td>
                                            <td>{{ $value->cliente }}</td>
                                            <td>
                        ...
                        <div class="accordion">
                            ...
                            @endif
                            @if($fectivo_soles['total_ahorro_recaudacioncuentabancarias']>0)
                            <a class="toggle" href="#"> Recaudaciones ({{ $fectivo_soles['total_ahorro_recaudacioncuentabancarias'] }})<i class="fa fa-angle-down"></i></a>
                            <div class="accordion-inner">
                               <div class="table-responsive">
                                  <table class="table" id="tabla-contenido">
                                      <thead class="thead-dark">
                                      ...
                                      <tbody>
                                          @foreach($fectivo_soles['ahorro_recaudacioncuentabancarias'] as $value)
                                          <tr>
                                            <td style="height: 40px;">{{ str_pad($value->codigo, 8, "0", STR_PAD_LEFT) }}</td>
                                            <td>{{ $value->cliente }}</td>
                    ...
                    <div id="tab-detalledeldia-2" class="tab-content" style="display: block;">
                        ...
                        <div class="accordion">
                            ...
                            @endif
                            @if($fectivo_dolares['total_ahorro_recaudaciones']>0)
                            <a class="toggle" href="#"> Recaudaciones ({{ $fectivo_dolares['total_ahorro_recaudaciones'] }})<i class="fa fa-angle-down"></i></a>
                            <div class="accordion-inner">
                               <div class="table-responsive">
                                  <table class="table" id="tabla-contenido">
                                      <thead class="thead-dark">
                                      ...
                                      <tbody>
                                          @foreach($fectivo_dolares['ahorro_recaudaciones'] as $value)
                                          <tr>
                                            <td style="height: 40px;">{{ str_pad($value->codigo, 8, "0", STR_PAD_LEFT) }}</td>
                                            <td>{{ $value->cliente }}</td>
                                            <td>
                            ...
                            @endif
                            @if($fectivo_dolares['total_ahorro_retiros']>0)
                            <a class="toggle" href="#"> Retiros ({{ $fectivo_dolares['total_ahorro_retiros'] }})<i class="fa fa-angle-down"></i></a>
                            <div class="accordion-inner">
                               <div class="table-responsive">
                                  <table class="table" id="tabla-contenido">
                                      <thead class="thead-dark">
                                      ...
                                      <tbody>
                                          @foreach($fectivo_dolares['ahorro_retiros'] as $value)
                                          <tr>
                                            <td style="height: 40px;">{{ str_pad($value->codigo, 8, "0", STR_PAD_LEFT) }}</td>
                                            <td>{{ $value->cliente }}</td>
                                            <td>
                        ...
                        <div class="accordion">
                            ...
                            @endif
                            @if($fectivo_dolares['total_ahorro_recaudacioncuentabancarias']>0)
                            <a class="toggle" href="#"> Recaudaciones ({{ $fectivo_dolares['total_ahorro_recaudacioncuentabancarias'] }})<i class="fa fa-angle-down"></i></a>
                            <div class="accordion-inner">
                               <div class="table-responsive">
                                  <table class="table" id="tabla-contenido">
                                      <thead class="thead-dark">
                                      ...
                                      <tbody>
                                          @foreach($fectivo_dolares['ahorro_recaudacioncuentabancarias'] as $value)
                                          <tr>
                                            <td style="height: 40px;">{{ str_pad($value->codigo, 8, "0", STR_PAD_LEFT) }}</td>
                                            <td>{{ $value->cliente }}</td>
                                            <td>{{ $value->monto_deposito }}</td>
