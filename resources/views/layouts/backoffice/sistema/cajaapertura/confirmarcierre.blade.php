...
@else
    @if($s_aperturacierre->montocobradoauxiliar>0)    
        @if($s_aperturacierre->config_sistema_moneda_usar==1)
        <div class="mensaje-success" style="background-color: #31353d;">
          Monto total cobrado S/:
          <div style="font-size: 20px;font-weight: bold;">{{ $s_aperturacierre->montocobradoauxiliar }}</div> 
        </div>  
        @elseif($s_aperturacierre->config_sistema_moneda_usar==2)
        <div class="mensaje-success" style="background-color: #31353d;">
          Monto total cobrado $:
          <div style="font-size: 20px;font-weight: bold;">{{ $s_aperturacierre->montocobradoauxiliar_dolares }}</div> 
        </div>  
...
<form action="javascript:;" 
    ...
    @if(configuracion($tienda->id,'prestamo_tipocierrecaja')['valor']==2)
        @if($s_aperturacierre->config_sistema_moneda_usar==1)
              ...
              <tbody>
                  ...
                  <tr>
                    <td id="cierremontosoles1" class="td-text" style="text-align: right;">200.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles1" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                    <td id="cierretotalsoles1" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontosoles2" class="td-text" style="text-align: right;">100.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles2" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                    <td id="cierretotalsoles2" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontosoles3" class="td-text" style="text-align: right;">50.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles3" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                    <td id="cierretotalsoles3" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontosoles4" class="td-text" style="text-align: right;">20.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles4" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                    <td id="cierretotalsoles4" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontosoles5" class="td-text" style="text-align: right;">10.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles5" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
              ...
              <tbody>
                  ...
                  <tr>
                    <td id="cierremontosoles6" class="td-text" style="text-align: right;">5.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles6" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                    <td id="cierretotalsoles6" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontosoles7" class="td-text" style="text-align: right;">2.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles7" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                    <td id="cierretotalsoles7" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontosoles8" class="td-text" style="text-align: right;">1.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles8" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                    <td id="cierretotalsoles8" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontosoles9" class="td-text" style="text-align: right;">0.50</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles9" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                    <td id="cierretotalsoles9" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontosoles10" class="td-text" style="text-align: right;">0.20</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles10" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                    <td id="cierretotalsoles10" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontosoles11" class="td-text" style="text-align: right;">0.10</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidadsoles11" onclick="billetaje_soles();" onkeyup="billetaje_soles();"></td> 
                ...
                <tr>
                  ...
                  <tr>
                    <td id="cierremontodolares1" class="td-text" style="text-align: right;">100.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares1" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares1" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares2" class="td-text" style="text-align: right;">50.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares2" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares2" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares3" class="td-text" style="text-align: right;">20.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares3" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares3" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares4" class="td-text" style="text-align: right;">10.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares4" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares4" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares5" class="td-text" style="text-align: right;">5.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares5" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares5" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares6" class="td-text" style="text-align: right;">2.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares6" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares6" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares7" class="td-text" style="text-align: right;">1.00</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares7" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
              ...
              <tbody>
                  ...
                  <tr>
                    <td id="cierremontodolares9" class="td-text" style="text-align: right;">0.50</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares9" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares9" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares10" class="td-text" style="text-align: right;">0.25</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares10" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares10" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares11" class="td-text" style="text-align: right;">0.10</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares11" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares11" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares12" class="td-text" style="text-align: right;">0.05</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares12" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
                    <td id="cierretotaldolares12" class="td-text">0.00</td>
                  </tr>
                  <tr>
                    <td id="cierremontodolares13" class="td-text" style="text-align: right;">0.01</td> 
                      <td><input type="number" placeholder="0" min="0" step="0.01" id="cierrecantidaddolares13" onclick="billetaje_dolares();" onkeyup="billetaje_dolares();"></td> 
