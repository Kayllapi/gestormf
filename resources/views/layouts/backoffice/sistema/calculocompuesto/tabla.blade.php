            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <label class="col-sm-6 col-form-label" style="text-align: right;">Fecha de Cálculo:</label>
                    <div class="col-sm-6">
                  ...
                  <div class="row d-none">
                    <label class="col-sm-6 col-form-label" style="text-align: right;">Cargo Mes S/.:</label>
                    <div class="col-sm-6">
