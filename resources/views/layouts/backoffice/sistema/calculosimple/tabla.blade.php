    ...
    <div class="col-sm-12">
      <div class="card">
        ...
        <div class="row mt-3 justify-content-center">
          ...
          <div class="col-sm-12 col-md-5" style="height: calc(-440px + 100vh);">
...
function show_producto_credito(){
  $.ajax({
    url:"{{url('backoffice/0/calculosimple/show_producto_credito')}}",
    type:'GET',
    data: {
...
function cronograma(){
  ...
  $.ajax({
      url:"{{url('backoffice/0/calculosimple/cronograma')}}",
      type: 'GET',
      data: {
          monto: monto,
...
function showtasa(){
  ...
  $.ajax({
    url:"{{url('backoffice/0/calculosimple/showtasa')}}",
    type:'GET',
    data: {
        producto: idproducto,
        monto: monto,
...
function show_tarifario_producto(){
  ...
  $.ajax({
    url:"{{url('backoffice/0/calculosimple/showtarifarioproducto')}}",
    type:'GET',
    data: {
