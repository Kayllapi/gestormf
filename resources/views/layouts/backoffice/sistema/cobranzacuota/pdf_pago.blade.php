...
<body>
    <div class="ticket_contenedor">
          ...
          <table style="width:100%;">
            ...
            <tr>
                <td style="border-top: 0.5px dashed #000;padding-top:5px;padding-bottom:5px;">
                    ...
                    $credito_ultadelanto = DB::table('credito_adelanto')
                        ...
                        ->first();
                    ?>
                <td width="5px" style="border-top: 0.5px dashed #000;padding-top:5px;padding-bottom:5px;text-align:right;">
                  @if($t_acuenta>0 && ($t_penalidad+$t_tenencia+$t_compensatorio)>0)
                  &nbsp;
                ...
                <td width="60px" style="border-top: 0.5px dashed #000;padding-top:5px;padding-bottom:5px;text-align:right;">
            ...
            <tr>
              <td style="border-bottom: 0.5px dashed #000;border-top: 0.5px dashed #000;padding-top:5px;padding-bottom:5px;">
                <b>Total</b> 
              </td>
                <td width="5px" style="border-bottom: 0.5px dashed #000;border-top: 0.5px dashed #000;padding-top:5px;padding-bottom:5px;text-align:right;">
                    <b>S/.:</b>
                </td>
              <td style="border-bottom: 0.5px dashed #000;border-top: 0.5px dashed #000;padding-top:5px;padding-bottom:5px;text-align:right;">
