...
<script>
  ...
  show_data_pagoacuenta();
  function show_data_pagoacuenta() {    
    $.ajax({
      url:"{{url('backoffice/'.$tienda->id.'/cobranzacuota/show_descuentodecuotas')}}",
      type:'GET',
      data: {
