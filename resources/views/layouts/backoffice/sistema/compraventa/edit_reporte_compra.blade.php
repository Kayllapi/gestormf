<form action="javascript:;" 
    ...
    <div class="modal-header">
        ...
        <button type="button" class="btn-close" id="modal-close-compra-reporte" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
        <div class="alert alert-danger">
            <i class="fa-solid fa-triangle-exclamation"></i> ¿Está seguro ver el reporte de la compra?<br>
        </div>
