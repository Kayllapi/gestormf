        ...
        <form action="javascript:;" 
              onsubmit="callback({
                  ...
                  data:   {
                      ...
                      documento_editar_contenido: CKEDITOR.instances.documento_editar_contenido.getData()
                  }
              },
              function(resultado){
                  index_documento();
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <select id="documento_editar_mostrar">
                <option></option>
                <option value="1">Desembolso de Crédito</option>
                <option value="2">Cobranza de Crédito</option>
              </select>
            </div>
            <div class="col-sm-12">
              <label>Nombre *</label>
              <input type="text" id="documento_editar_nombre" value="{{ $prestamodocumento->nombre }}" onkeyup="texto_mayucula(this)">
            </div>
            <div class="col-sm-12" style="text-align: left;float:left">
              <textarea name="documento_editar_contenido" id="documento_editar_contenido">{{ $prestamodocumento->contenido }}</textarea>
            </div>
          </div>
        ...
        <div class="row">
            <div class="col-md-4">
              <table class='table'>
                  ...
                  <tr>
                    <th colspan="2" style='padding: 8px;text-align: center;background-color: #31353c;color: #fff;'>Asesor</th>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>DNI</td>
                    <td style='padding: 8px;text-align: left;'>[asesor_dni]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Nombre</td>
                    <td style='padding: 8px;text-align: left;'>[asesor_nombre]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Apellidos</td>
                    <td style='padding: 8px;text-align: left;'>[asesor_apellidos]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Número de Teléfono</td>
                    <td style='padding: 8px;text-align: left;'>[asesor_numerotelefono]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Dirección</td>
                    <td style='padding: 8px;text-align: left;'>[asesor_direccion]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Distrito - Provincia - Departamento</td>
                    <td style='padding: 8px;text-align: left;'>[asesor_ubigeo]</td>
                  </tr>
              </table>
            </div>
            <div class="col-md-4">
              <table class='table'>
                  ...
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Número de Teléfono</td>
                    <td style='padding: 8px;text-align: left;'>[cliente_numerotelefono]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Dirección</td>
                  ...
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Número de Teléfono</td>
                    <td style='padding: 8px;text-align: left;'>[conyugue_numerotelefono]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Dirección</td>
                  ...
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Número de Teléfono</td>
                    <td style='padding: 8px;text-align: left;'>[garante_numerotelefono]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Dirección</td>
            ...
            <div class="col-md-4">
              <table class='table'>
                  ...
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Total Interes</td>
                    <td style='padding: 8px;text-align: left;'>[credito_totalinteres]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Mora Cancelada</td>
                    <td style='padding: 8px;text-align: left;'>[credito_moraapagar_cancelada]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Mora Vencida</td>
                    <td style='padding: 8px;text-align: left;'>[credito_moraapagar_vencida]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Total Acuenta</td>
                    <td style='padding: 8px;text-align: left;'>[credito_totalacuenta]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Pago Minímo</td>
                    <td style='padding: 8px;text-align: left;'>[credito_pagominimo]</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Cuotas Vencidas</td>
                    <td style='padding: 8px;text-align: left;'>[credito_cuotas_vencidas]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Días de Moras Vencidas</td>
                    <td style='padding: 8px;text-align: left;'>[credito_dias_moras_vencidas]</td>
                  </tr>
                
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Deuda Capital Cancelada</td>
                    <td style='padding: 8px;text-align: left;'>[credito_deudacapital_cancelada]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Deuda Capital Vencida</td>
                    <td style='padding: 8px;text-align: left;'>[credito_deudacapital_vencida]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Deuda Capital Restante</td>
                    <td style='padding: 8px;text-align: left;'>[credito_deudacapital_restante]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Deuda Capital Pendiente</td>
                    <td style='padding: 8px;text-align: left;'>[credito_deudacapital_pendiente]</td>
                  </tr>
                
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Deuda Cancelada</td>
                    <td style='padding: 8px;text-align: left;'>[credito_deuda_cancelada]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Deuda Vencida</td>
                    <td style='padding: 8px;text-align: left;'>[credito_deuda_vencida]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Deuda Restante</td>
                    <td style='padding: 8px;text-align: left;'>[credito_deuda_restante]</td>
                  </tr>
                  <tr>
                    <td style='padding: 8px;text-align: left;'>Deuda Pendiente</td>
                    <td style='padding: 8px;text-align: left;'>[credito_deuda_pendiente]</td>
                  </tr>
                  <tr>
...
<script>
  ...
  CKEDITOR.replace('documento_editar_contenido', {
      height: 600,
      /*toolbarGroups: [
    ...
    $('#documento_editar_mostrar').select2({
        placeholder: "--  Seleccionar --",
        minimumResultsForSearch: -1
    }).val({{ $prestamodocumento->idmostrar }}).trigger("change"); 
</script>