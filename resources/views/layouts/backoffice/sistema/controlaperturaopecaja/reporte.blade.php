    ...
    <div class="modal-body">
        ...
        style="height: calc(100vh - 85px)"></iframe>
            </div>
          </div>
    </div>
...
<script>
    ...
    function reporte_pdf(){
        ...
        $('#iframe_reporte').attr('src','{{ url('/backoffice/'.$tienda->id.'/controlaperturaopecaja/0/edit?view=reporte_pdf') }}&fecha_corte_reporte='+fecha_corte_reporte+'#zoom=100');
    }
</script> 
