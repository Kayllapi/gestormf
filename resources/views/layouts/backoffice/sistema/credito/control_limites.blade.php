<form action="javascript:;" 
    ...
    <div class="modal-body modal-body-cualitativa">
      ...
      <div class="mb-1 mt-2">
        <span class="badge d-block" style="background-color: #aaa;color: #000;">
          {{ $users_prestamo->idfuenteingreso == 1 ? ($credito->idevaluacion == 1 ? '' : '') : ($users_prestamo->idfuenteingreso == 2 ? '7.1.1' : '') }} SALDO DE DEUDA VIGENTE DEL CLIENTE
        </span>
      </div>
        ...
        <div class="col-sm-12 col-md-6">
          <div class="row">
            <div class="col-sm-12 col-md-8">
              <div class="row">
                <label class="col-sm-5 col-form-label" style="text-align: right;">Apellidos y Nombres:</label>
                <div class="col-sm-7">
              ...
              <div class="row">
                <label class="col-sm-5 col-form-label" style="text-align: right;">PAREJA:</label>
                <div class="col-sm-7">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="row">
                <label class="col-sm-5 col-form-label" style="text-align: right;">RUC/DNI/CE:</label>
                <div class="col-sm-7">
      ...
      <div class="mb-1 mt-2">
        <span class="badge d-block" style="background-color: #aaa;color: #000;">
          {{ $users_prestamo->idfuenteingreso == 1 ? ($credito->idevaluacion == 1 ? '' : '') : ($users_prestamo->idfuenteingreso == 2 ? '7.2.1' : '') }} SALDO DE DEUDA VIGENTE DEL AVAL
        </span>
      </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <table class="table table-bordered" id="table-vinculo-deudor">
            <thead style="border: 1px solid transparent !important;">
              <tr>
                <th rowspan=3 style="width:100px;">RUC/DNI/CE CLIENTE</th>
