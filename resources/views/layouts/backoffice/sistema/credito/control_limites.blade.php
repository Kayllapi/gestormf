<form action="javascript:;" 
    ...
    <div class="modal-body modal-body-cualitativa">
      ...
      <div class="mb-1 mt-2">
        <span class="badge d-block" style="background-color: #aaa;color: #000;">
          {{ $users_prestamo->idfuenteingreso == 1 ? ($credito->idevaluacion == 1 ? '' : '') : ($users_prestamo->idfuenteingreso == 2 ? '' : '') }} SALDO DE DEUDA VIGENTE DEL CLIENTE
        </span>
      </div>
      ...
      <div class="mb-1 mt-2">
        <span class="badge d-block" style="background-color: #aaa;color: #000;">
          {{ $users_prestamo->idfuenteingreso == 1 ? ($credito->idevaluacion == 1 ? '' : '') : ($users_prestamo->idfuenteingreso == 2 ? '' : '') }} SALDO DE DEUDA VIGENTE DEL AVAL
        </span>
      </div>
