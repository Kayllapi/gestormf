    ...
    <div class="modal-body">
      <div class="row">
          <div class="col-md-7 mt-3">
              ...
              <div class="col-md-6">
                ...
                <div class="row">
                  <label class="col-sm-12 text-end" style="color: #b32121;">Costo por custodia de garantia para cargo: ({{ configuracion($tienda->id,'comision_gestion_garantia_cargo')['valor'] }}% de Cobertura Mensual)</label>
                </div>
                @else
                <div class="row">
      ...
      <script>
        ...
        function cronograma(){
          ...
          if(numerocuota<=0){
              var mensaje = "El Número de Cuotas debe ser mayor a 0.";
              modal({ route:"{{url('backoffice/'.$tienda->id.'/inicio/create?view=alerta')}}&mensaje="+mensaje, size: 'modal-sm' });  
              return false;
          }
          
          if(dia_gracia<0){
              var mensaje = "El día de gracia debe ser mayor o igual a 0!!.";
              modal({ route:"{{url('backoffice/'.$tienda->id.'/inicio/create?view=alerta')}}&mensaje="+mensaje, size: 'modal-sm' });  
              return false;
          }
          if(dia_gracia > {{$diasdegracia}}){
              var mensaje = "Máximo puede poner {{$diasdegracia}} días de gracia!!.";
              modal({ route:"{{url('backoffice/'.$tienda->id.'/inicio/create?view=alerta')}}&mensaje="+mensaje, size: 'modal-sm' });  
              return false;
          }
