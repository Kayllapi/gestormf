              ...
              <tr>
                ...
                <td style="width:50px;">
                  <span class=""
                    ...
                    <i class="fa-solid fa-exclamation" style="font-size: 16px; color: #d43c49; position: relative; float: inline-start; font-style: normal !important;"></i>
                  </span>
                </td>
                <td>
                  %
...
<script>
  ...
  function total_balance_general(){
    ...
    if(isNaN(analisis_vertical_caja) || analisis_vertical_caja == Infinity || analisis_vertical_caja == -Infinity){ analisis_vertical_caja = 0; }
    ...
    if(isNaN(analisis_vertical_bancos) || analisis_vertical_bancos == Infinity || analisis_vertical_bancos == -Infinity){ analisis_vertical_bancos = 0; }
    ...
    if(isNaN(analisis_vertical_cuentas_cobrar) || analisis_vertical_cuentas_cobrar == Infinity || analisis_vertical_cuentas_cobrar == -Infinity){ analisis_vertical_cuentas_cobrar = 0; }
    ...
    if(isNaN(analisis_vertical_adelanto_prove) || analisis_vertical_adelanto_prove == Infinity || analisis_vertical_adelanto_prove == -Infinity){ analisis_vertical_adelanto_prove = 0; }
    ...
    if(isNaN(analisis_vertical_inventario) || analisis_vertical_inventario == Infinity || analisis_vertical_inventario == -Infinity){ analisis_vertical_inventario = 0; }
    ...
    if(isNaN(analisis_vertical_activo_corriente) || analisis_vertical_activo_corriente == Infinity || analisis_vertical_activo_corriente == -Infinity){ analisis_vertical_activo_corriente = 0; }
    ...
    if(isNaN(analisis_vertical_activo_inmueble) || analisis_vertical_activo_inmueble == Infinity || analisis_vertical_activo_inmueble == -Infinity){ analisis_vertical_activo_inmueble = 0; }
    ...
    if(isNaN(analisis_vertical_activo_mueble) || analisis_vertical_activo_mueble == Infinity || analisis_vertical_activo_mueble == -Infinity){ analisis_vertical_activo_mueble = 0; }
    ...
    if(isNaN(analisis_vertical_pagos_proveedor) || analisis_vertical_pagos_proveedor == Infinity || analisis_vertical_pagos_proveedor == -Infinity){ analisis_vertical_pagos_proveedor = 0; }
    ...
    if(isNaN(analisis_vertical_pasivo_corto_regulada) || analisis_vertical_pasivo_corto_regulada == Infinity || analisis_vertical_pasivo_corto_regulada == -Infinity){ analisis_vertical_pasivo_corto_regulada = 0; }
    ...
    if(isNaN(analisis_vertical_pasivo_corto_noregulada) || analisis_vertical_pasivo_corto_noregulada == Infinity || analisis_vertical_pasivo_corto_noregulada == -Infinity){ analisis_vertical_pasivo_corto_noregulada = 0; }
    ...
    if(isNaN(analisis_vertical_impuestos) || analisis_vertical_impuestos == Infinity || analisis_vertical_impuestos == -Infinity){ analisis_vertical_impuestos = 0; }
    ...
    if(isNaN(analisis_vertical_otras_cuentas) || analisis_vertical_otras_cuentas == Infinity || analisis_vertical_otras_cuentas == -Infinity){ analisis_vertical_otras_cuentas = 0; }
    ...
    if(isNaN(analisis_vertical_pasivo_corriente) || analisis_vertical_pasivo_corriente == Infinity || analisis_vertical_pasivo_corriente == -Infinity){ analisis_vertical_pasivo_corriente = 0; }
    ...
    if(isNaN(analisis_vertical_pasivo_largo_regulada) || analisis_vertical_pasivo_largo_regulada == Infinity || analisis_vertical_pasivo_largo_regulada == -Infinity){ analisis_vertical_pasivo_largo_regulada = 0; }
    ...
    if(isNaN(analisis_vertical_pasivo_largo_noregulada) || analisis_vertical_pasivo_largo_noregulada == Infinity || analisis_vertical_pasivo_largo_noregulada == -Infinity){ analisis_vertical_pasivo_largo_noregulada = 0; }
    ...
    if(isNaN(analisis_vertical_pasivo_nocorriente) || analisis_vertical_pasivo_nocorriente == Infinity || analisis_vertical_pasivo_nocorriente == -Infinity){ analisis_vertical_pasivo_nocorriente = 0; }
    ...
    if(isNaN(analisis_vertical_total_pasivo) || analisis_vertical_total_pasivo == Infinity || analisis_vertical_total_pasivo == -Infinity){ analisis_vertical_total_pasivo = 0; }
    ...
    if(isNaN(analisis_vertical_capital_social) || analisis_vertical_capital_social == Infinity || analisis_vertical_capital_social == -Infinity){ analisis_vertical_capital_social = 0; }
    ...
    if(isNaN(analisis_vertical_utilidad_acumulada) || analisis_vertical_utilidad_acumulada == Infinity || analisis_vertical_utilidad_acumulada == -Infinity){ analisis_vertical_utilidad_acumulada = 0; }
    ...
    if(isNaN(analisis_vertical_patrimonio) || analisis_vertical_patrimonio == Infinity || analisis_vertical_patrimonio == -Infinity){ analisis_vertical_patrimonio = 0; }
    ...
    if(isNaN(analisis_vertical_pasivo_patrimonio) || analisis_vertical_pasivo_patrimonio == Infinity || analisis_vertical_pasivo_patrimonio == -Infinity){ analisis_vertical_pasivo_patrimonio = 0; }
    ...
    if(isNaN(analisis_horizontal_caja) || analisis_horizontal_caja == Infinity || analisis_horizontal_caja == -Infinity){ analisis_horizontal_caja = 0; }
    ...
    if(isNaN(analisis_horizontal_bancos) || analisis_horizontal_bancos == Infinity || analisis_horizontal_bancos == -Infinity){ analisis_horizontal_bancos = 0; }
    ...
    if(isNaN(analisis_horizontal_cuentas_cobrar) || analisis_horizontal_cuentas_cobrar == Infinity || analisis_horizontal_cuentas_cobrar == -Infinity){ analisis_horizontal_cuentas_cobrar = 0; }
    ...
    if(isNaN(analisis_horizontal_adelanto_prove) || analisis_horizontal_adelanto_prove == Infinity || analisis_horizontal_adelanto_prove == -Infinity){ analisis_horizontal_adelanto_prove = 0; }
    ...
    if(isNaN(analisis_horizontal_inventario) || analisis_horizontal_inventario == Infinity || analisis_horizontal_inventario == -Infinity){ analisis_horizontal_inventario = 0; }
    ...
    if(isNaN(analisis_horizontal_activo_corriente) || analisis_horizontal_activo_corriente == Infinity || analisis_horizontal_activo_corriente == -Infinity){ analisis_horizontal_activo_corriente = 0; }
    ...
    if(isNaN(analisis_horizontal_activo_inmueble) || analisis_horizontal_activo_inmueble == Infinity || analisis_horizontal_activo_inmueble == -Infinity){ analisis_horizontal_activo_inmueble = 0; }
    ...
    if(isNaN(analisis_horizontal_activo_mueble) || analisis_horizontal_activo_mueble == Infinity || analisis_horizontal_activo_mueble == -Infinity){ analisis_horizontal_activo_mueble = 0; }
    ...
    if(isNaN(analisis_horizontal_activo_nocorriente) || analisis_horizontal_activo_nocorriente == Infinity || analisis_horizontal_activo_nocorriente == -Infinity){ analisis_horizontal_activo_nocorriente = 0; }
    ...
    if(isNaN(analisis_horizontal_total_activo) || analisis_horizontal_total_activo == Infinity || analisis_horizontal_total_activo == -Infinity){ analisis_horizontal_total_activo = 0; }
    ...
    if(isNaN(analisis_horizontal_pagos_proveedor) || analisis_horizontal_pagos_proveedor == Infinity || analisis_horizontal_pagos_proveedor == -Infinity){ analisis_horizontal_pagos_proveedor = 0; }
    ...
    if(isNaN(analisis_horizontal_pasivo_corto_regulada) || analisis_horizontal_pasivo_corto_regulada == Infinity || analisis_horizontal_pasivo_corto_regulada == -Infinity){ analisis_horizontal_pasivo_corto_regulada = 0; }
    ...
    if(isNaN(analisis_horizontal_pasivo_corto_noregulada) || analisis_horizontal_pasivo_corto_noregulada == Infinity || analisis_horizontal_pasivo_corto_noregulada == -Infinity){ analisis_horizontal_pasivo_corto_noregulada = 0; }
    ...
    if(isNaN(analisis_horizontal_impuestos) || analisis_horizontal_impuestos == Infinity || analisis_horizontal_impuestos == -Infinity){ analisis_horizontal_impuestos = 0; }
    ...
    if(isNaN(analisis_horizontal_otras_cuentas) || analisis_horizontal_otras_cuentas == Infinity || analisis_horizontal_otras_cuentas == -Infinity){ analisis_horizontal_otras_cuentas = 0; }
    ...
    if(isNaN(analisis_horizontal_pasivo_corriente) || analisis_horizontal_pasivo_corriente == Infinity || analisis_horizontal_pasivo_corriente == -Infinity){ analisis_horizontal_pasivo_corriente = 0; }
    ...
    if(isNaN(analisis_horizontal_pasivo_largo_regulada) || analisis_horizontal_pasivo_largo_regulada == Infinity || analisis_horizontal_pasivo_largo_regulada == -Infinity){ analisis_horizontal_pasivo_largo_regulada = 0; }
    ...
    if(isNaN(analisis_horizontal_pasivo_largo_noregulada) || analisis_horizontal_pasivo_largo_noregulada == Infinity || analisis_horizontal_pasivo_largo_noregulada == -Infinity){ analisis_horizontal_pasivo_largo_noregulada = 0; }
    ...
    if(isNaN(analisis_horizontal_pasivo_nocorriente) || analisis_horizontal_pasivo_nocorriente == Infinity || analisis_horizontal_pasivo_nocorriente == -Infinity){ analisis_horizontal_pasivo_nocorriente = 0; }
    ...
    if(isNaN(analisis_horizontal_total_pasivo) || analisis_horizontal_total_pasivo == Infinity || analisis_horizontal_total_pasivo == -Infinity){ analisis_horizontal_total_pasivo = 0; }
    ...
    if(isNaN(analisis_horizontal_capital_social) || analisis_horizontal_capital_social == Infinity || analisis_horizontal_capital_social == -Infinity){ analisis_horizontal_capital_social = 0; }
    ...
    if(isNaN(analisis_horizontal_utilidad_acumulada) || analisis_horizontal_utilidad_acumulada == Infinity || analisis_horizontal_utilidad_acumulada == -Infinity){ analisis_horizontal_utilidad_acumulada = 0; }
    ...
    if(isNaN(analisis_horizontal_patrimonio) || analisis_horizontal_patrimonio == Infinity || analisis_horizontal_patrimonio == -Infinity){ analisis_horizontal_patrimonio = 0; }
    ...
    if(isNaN(analisis_horizontal_pasivo_patrimonio) || analisis_horizontal_pasivo_patrimonio == Infinity || analisis_horizontal_pasivo_patrimonio == -Infinity){ analisis_horizontal_pasivo_patrimonio = 0; }
