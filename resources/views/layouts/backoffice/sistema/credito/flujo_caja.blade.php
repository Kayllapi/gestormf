...
//                 copiar_valor_fila('ingreso_fijo');
                ...
                function calcular_saldo_mensual(){
                  ...
                  if(mes_cero_saldo_caja<=0){
                      $('#mes_cero_saldo_caja').attr('style', 'background-color: #dc3545 !important;border-color: #dc3545 !important;');
                  }
                  ...
                  if(mes_cero_saldo_acumulado<=0){
                      $('#mes_cero_saldo_acumulado').attr('style', 'background-color: #dc3545 !important;border-color: #dc3545 !important;');
                  }
