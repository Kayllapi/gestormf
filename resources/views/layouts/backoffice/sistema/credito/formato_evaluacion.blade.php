<form action="javascript:;" 
    ...
    <div class="modal-body modal-body-cualitativa">
          ...
          <table class="table table-bordered" id="table-propuesta">
            <thead style="border-color: transparent !important;">
              ...
              <tr>
                ...
                <th rowspan=2 width="80px">{{ $credito->modalidad_calculo == 'Interes Compuesto' ? 'TEM' : 'TNM' }}</th>
      ...
      <div class="mb-1 mt-2">
        <span class="badge d-block">III. COMENTARIOS: CENTRO LABORAL, T. CONTRATO, ANTIGÜEDAD, CONTINUIDAD Y FORTALEZAS</span>
      </div>
      <div class="row">
        <div class="col-sm-12">
