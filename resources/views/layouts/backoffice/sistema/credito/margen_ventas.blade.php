<form action="javascript:;" 
    ...
    <div class="modal-body modal-body-cualitativa">
      ...
      <div class="mb-1 mt-2">
        <span class="badge d-block" style="background-color: #aaa;color: #000;">4.1 VENTAS DENTRO DE LA SEMANA (VENTAS CON <span style="background-color: #E8E585 !important;">FRECUENCIA DIARIA Y SEMANAL</span>)</span>
      </div>
      <div class="row">
        <div class="col-sm-9">
