...
<body>
  ...
  <main>
    ...
    <div class="row">
      <div class="col" style="width:354px;">
      ...
      <div class="col">
        <table class="table">
            <thead>
              ...
              <tr>
                <th width="115px">ESTADO DE GANANCIAS Y PERDIDAS</th>
                <th width="50px">Soles (S/. )</th>
                <th width="50px">Soles (S/. )</th>
                <th width="50px">Análisis Vertical(%)</th>
                <th width="50px">Análisis Horizontal (%)</th>
            ...
            <tbody>
              ...
              <tr>
                <td>- Cuota de Prést. de Consumo, Hipotecarios para Vivienda (Reg. y no Reg.) y L. de Cred. no Utiliz.</td>
                <?php
    ...
    <div class="row" >
      <div class="col" style="width:100%; margin-top:-8px;">
        <span class="badge subtitle m-0">3.5 COMENTARIOS DE ASPECTOS RESALTANTES Y ANÁLISIS</span>
        <div class="row">
