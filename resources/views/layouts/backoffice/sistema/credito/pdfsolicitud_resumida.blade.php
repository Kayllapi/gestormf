...
<body>
  ...
  <main>
        ...
        <table class="table">
          <thead>
            ...
            <tr>
              ...
              <th style="color: #000 !important;" rowspan=2>{{ $credito->modalidad_calculo == 'Interes Compuesto' ? 'TEM' : 'TNM' }}</th>
    ...
    <div class="row">
      <textarea style="border:solid 1px #000000;"  id="detalle_destino_prestamo" class="form-control">{{ $credito_evaluacion_resumida ? $credito_evaluacion_resumida->detalle_destino_prestamo : '' }}</textarea>
    </div>
    <span class="badge subtitle">V. COMENTARIOS Y ESPECIFICACIONES DE FORTALEZAS DEL NEGOCIO</span>
    <div class="row">
      <textarea style="border:solid 1px #000000;"  id="fortalezas_negocio" class="form-control">{{ $credito_evaluacion_resumida ? $credito_evaluacion_resumida->fortalezas_negocio : '' }}</textarea>
    </div>
    <div class="row" >
