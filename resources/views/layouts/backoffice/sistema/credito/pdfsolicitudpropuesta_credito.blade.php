              ...
              <tbody>
                ...
                @if($users_prestamo->idfuenteingreso == 1)
                  ...
                  <tr>
                    ...
                    <td colspan=2><input type="text" class="form-control color_cajatexto" id="rentabilidad_patrimonial_res_coment" 
                  ...
                  <tr>
                    ...
                    <td colspan=2><input type="text" class="form-control color_cajatexto" id="rentabilidad_activos_res_coment" 
                ...
                <tr>
                  ...
                  <td><span>{{ $limites_financiamiento_vru_res }}</span></td>
                ...
                @if($credito->idevaluacion == 2 or $users_prestamo->idfuenteingreso == 2)
                  <tr>
                    ...
                    <td colspan=2><input type="text" style="{{$stylebackground_limites_numero_entidades_res}}" class="form-control color_cajatexto doble-subrayado" id="limites_numero_entidades_res_coment" 
          ...
          <div class="col" style="width:100%;">
            <table class="table" style="width:100%;">
              ...
              <tbody>
                ...
                <tr>
                  <th colspan=7 style="text-align: left"><b>GESTIÓN</b></th>
                </tr>
                <tr>
                  <td>Plazo prom.rotación de invent.</td>
                  <td>Días</td>
            ...
            <table class="table" style="width:100%;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><span class="">{{ $res_ratios_cuota_ingreso_mensual_res }}</span></td>
                ...
                @if($res_ratios_venta_cuota_semanal > 0)
                  <tr>
                    ...
                    <td><span class="">{{ $res_ratios_venta_cuota_semanal_res }}</span></td>
