...
<div class="modal-body">
    <iframe src="{{ url('/backoffice/'.$tienda->id.'/credito/'.$credito->id.'/edit?view=pdfsolicitud_cuantitativa') }}#zoom=100" frameborder="0" width="100%" style="height: calc(100vh - 54px)"></iframe>
</div>
