...
<script>
  @include('app.nuevosistema.select2',['input'=>'#idtipo_credito', 'val' => $credito->idtipo_credito])
  ...
  function eliminar_credito(){
    modal({ route:"{{url('backoffice/'.$tienda->id.'/creditoordinario/'.$credito->id.'/edit?view=eliminar')}}" });  
  }
</script>    