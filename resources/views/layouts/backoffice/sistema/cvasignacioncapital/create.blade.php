          ...
          <div class="col-sm-12 col-md-6">
            <div id="cont_tipooperacion" style="display:none;">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                    <button type="button" class="btn btn-success" onclick="valid_registro()"><i class="fa-solid fa-floppy-disk"></i> Registrar</button>
                </div>
              </div>
          </div>
       </div>
...
<script>
  ...
  $("#idtipooperacion").on("change", function(e) {
    ...
    function valid_registro(){
        ...
        function(resultado){
            modal({ route:"{{url('backoffice/'.$tienda->id.'/cvasignacioncapital/0/edit?view=valid_registro')}}&idtipooperacion="+idtipooperacion,  size: 'modal-sm'  });
        })        
    }
