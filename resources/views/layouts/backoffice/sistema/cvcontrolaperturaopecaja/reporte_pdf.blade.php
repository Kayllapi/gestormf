      ...
      <h4 align="center">REPORTE DE CONTROL DE APERTURA Y CIERRE DE OPE. DE CAJA</h4>
          ...
          $html = '<table style="width:100%;border-bottom: 2px solid #000;">
              <thead>
                <tr>
                  ...
                  <td colspan="4" style="border-top: 2px solid #000;border-bottom: 2px solid #000;text-align:center;font-weight: bold;">CIERRE DE CAJA</td>
                </tr>
                <tr>
                  ...
                  <td style="border-bottom: 2px solid #000;text-align:center;font-weight: bold;">Estado</td>
                  <td style="border-bottom: 2px solid #000;text-align:center;font-weight: bold;">Fecha y Hora</td>
                  <td style="border-bottom: 2px solid #000;text-align:center;font-weight: bold;">Administrador de Agencia  (A. y N.)</td>
                  <td style="border-bottom: 2px solid #000;text-align:center;font-weight: bold;">Usuario</td>
                </tr>
              </thead>
              <tbody>';
          $i = 1;
          foreach($cierre_insitucionaldetalle as $value){
              ...
              $html .= '<tr>
                            ...
                            <td>'.$nombrecompleto_responsable.'</td>
