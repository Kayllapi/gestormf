<form action="javascript:;" 
      onsubmit="callback({
          route: '{{ url('backoffice/'.$tienda->id.'/cvgastoadministrativooperativo/'.$gastoadministrativooperativo->id) }}',
          method: 'DELETE',
          data:{
              view: 'eliminar'
          }
      ...
      function(resultado){
          ...
          $('#modal-close-gastoadministrativooperativo-eliminar').click();
      },this)">
    <div class="modal-header">
        <h5 class="modal-title">Eliminar Gasto Administrativo y Operativo</h5>
        <button type="button" class="btn-close" id="modal-close-gastoadministrativooperativo-eliminar" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
