<form action="javascript:;" 
      onsubmit="callback({
          route: '{{ url('backoffice/'.$tienda->id.'/cvingresoextraordinario/'.$ingresoextraordinario->id) }}',
          method: 'DELETE',
          data:{
              view: 'eliminar'
          }
      ...
      function(resultado){
          ...
          $('#modal-close-ingresoextraordinario-eliminar').click();
      },this)">
    <div class="modal-header">
        <h5 class="modal-title">Eliminar Gasto Administrativo y Operativo</h5>
        <button type="button" class="btn-close" id="modal-close-ingresoextraordinario-eliminar" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
