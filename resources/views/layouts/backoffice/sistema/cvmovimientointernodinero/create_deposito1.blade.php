...
<script>
    ...
    function valid_registro_deposito1(){
      ...
      function(resultado){
          ...
          modal({ route:"{{url('backoffice/'.$tienda->id.'/cvmovimientointernodinero/0/edit?view=valid_registro_deposito1')}}&idfuenteretiro_deposito1="+idfuenteretiro_deposito1,  size: 'modal-sm'  });  
      })
    }
