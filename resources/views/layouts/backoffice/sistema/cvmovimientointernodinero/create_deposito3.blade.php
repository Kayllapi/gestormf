...
<script>
    ...
    function valid_registro_deposito3(){
      ...
      function(resultado){
          ...
          modal({ route:"{{url('backoffice/'.$tienda->id.'/cvmovimientointernodinero/0/edit?view=valid_registro_deposito3')}}&idfuenteretiro_deposito3="+idfuenteretiro_deposito3,  size: 'modal-sm'  });  
      })
    }
