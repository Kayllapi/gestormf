       ...
       <div class="row justify-content-center">
          ...
          <div class="col-sm-12 col-md-5">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                    <button type="button" onclick="eliminar_movimientointernodinero_retiro1()" class="btn btn-danger" id="btn_eliminar"><i class="fa-solid fa-trash"></i> ELIMINAR</button>
                </div>
              </div>
          </div>
       </div>
...
<script>
  ...
  function eliminar_movimientointernodinero_retiro1(){
    modal({ route:"{{url('backoffice/'.$tienda->id.'/cvmovimientointernodinero/'.$movimientointernodinero->id.'/edit?view=eliminar_retiro1')}}",  size: 'modal-sm'  });  
  }
</script>