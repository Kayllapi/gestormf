<form action="javascript:;" 
      onsubmit="callback({
          route: '{{ url('backoffice/'.$tienda->id.'/cvmovimientointernodineroinsti/0') }}',
          method: 'PUT',
          data:{
              view: 'valid_registro_retiro2'
          }
      },
      function(resultado){
          $('#idresponsable_retiro2').val(resultado.idresponsable);
          $('#idresponsable_permiso_retiro2').val($('#idresponsable :selected').attr('idpermiso'));
          submit_registro_retiro2();
