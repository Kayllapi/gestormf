<form action="javascript:;" 
      onsubmit="callback({
          route: '{{ url('backoffice/'.$tienda->id.'/cvreporteconsolidadoopecaja/'.$arqueocaja->id) }}',
          method: 'PUT',
          data:{
              view: 'valid_eliminar_arqueocaja'
          }
      },
      function(resultado){
          verpdf();
          $('#modal-close-reporteconsolidadoopecaja-valid-eliminar').click();
          $('#modal-close-reporteconsolidadoopecaja-valid').click();
      },this)">
    <div class="modal-header">
        <h5 class="modal-title">Validar</h5>
        <button type="button" class="btn-close" id="modal-close-reporteconsolidadoopecaja-valid-eliminar" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
