...
<div class="list-single-main-wrapper fl-wrap">
    <div class="breadcrumbs gradient-bg fl-wrap">
      <span>{{$s_categoria->nombre}} / Registrar</span>
      <a class="btn btn-success" href="{{ url('backoffice/tienda/sistema/'.$tienda->id.'/categoria/'.$s_categoria->id.'/edit?view=indexsubcategoria') }}"><i class="fa fa-angle-left"></i> Ir Atras</a></a>
    </div>
</div>
<form class="js-validation-signin px-30" 
      ...
      onsubmit="callback({
        ...
        method: 'PUT',
        data:{
            view: 'registrarsubcategoria'
        }
    },
    function(resultado){
        location.href = '{{ url('backoffice/tienda/sistema/'.$tienda->id.'/categoria/'.$s_categoria->id.'/edit?view=indexsubcategoria') }}';                                                                            
    },this)">
