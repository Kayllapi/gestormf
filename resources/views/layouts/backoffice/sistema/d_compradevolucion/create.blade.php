...
<div class="list-single-main-wrapper fl-wrap">
    <div class="breadcrumbs gradient-bg fl-wrap">
        <span>Registrar Compra de Devolución</span>
       ...
       <div class="profile-edit-container">
        ...
        <div id="cont-form-compradevolucion" style="display:none;">
            <form class="js-validation-signin px-30" 
                  action="javascript:;" 
                  onsubmit="callback({
                    route: 'backoffice/tienda/sistema/{{ $tienda->id }}/compradevolucion',         
                    method: 'POST',
                    data:{
                        view: 'registrar',
...
function buscar_venta(compracodigo){
     load('#carga-devolucioncompra'); 
      ...
      $.ajax({
            url:"{{url('backoffice/tienda/sistema/'.$tienda->id.'/compradevolucion/show_buscarcompra')}}",
            type:'GET',
            data: {
