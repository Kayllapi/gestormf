...
<div class="list-single-main-wrapper fl-wrap">
    <div class="breadcrumbs gradient-bg fl-wrap">
      <span>Ticket de Comprobante</span>
...
?>
    @if($facturacionboletafactura->respuestaestado=='ACEPTADA' && $codigo != 125
    or ($facturacionboletafactura->comunicacionbaja_correlativo!='' && $facturacionboletafactura->venta_tipodocumento=='01')
    or ($facturacionboletafactura->resumen_correlativo!='' && $facturacionboletafactura->venta_tipodocumento=='03')
    or $facturacionboletafactura->respuestacodigo == 1033)
        <div class="mensaje-info"><?php echo $facturacionboletafactura->respuestacodigo ?> - <?php echo $facturacionboletafactura->respuestamensaje ?></div>
    ...
    @else
        @if(isset($_GET['estado']))
          <div class="mensaje-warning"><?php echo $mensaje ?></div>
        @else
        ...
        @endif
          <div class="mensaje-info">{{$facturacionboletafactura->venta_serie}} - {{ str_pad($facturacionboletafactura->venta_correlativo, 8, "0", STR_PAD_LEFT) }}</div>
