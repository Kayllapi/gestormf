                    ...
                    <table class="table" id="tabla-contenido" style="margin-bottom: 5px;">
                        <thead class="thead-dark">
                            ...
                            <tr>
                                ...
                                <td colspan="{{ configuracion($tienda->id,'sistema_estadostock')['valor']==1?'4':'3' }}" class="mx-td-input">
...
function registrar_guiaremision(){
    callback({
        route: 'backoffice/tienda/sistema/{{ $tienda->id }}/facturacionguiaremision',
        method: 'POST',
  ...
  @if(configuracion($tienda->id,'facturacion_empresapordefecto')['resultado']=='CORRECTO')
        $("#idagencia").select2({
            ...
            $.ajax({
                    url:"{{url('backoffice/tienda/sistema/'.$tienda->id.'/facturacionguiaremision/show-selecionarserie')}}",
                    type:'GET',
                    data: {
...
$("#destinatario").select2({
    ...
    $.ajax({
        url:  "{{url('backoffice/tienda/sistema/'.$tienda->id.'/facturacionguiaremision/showseleccionarusuario')}}",
        type: 'GET',
        data: {
...
$('#facturador_serie, #facturador_correlativo').keyup(function(e) {
    ...
    if (code==13) {
        ...
        function cargarventa_venta(iddocumento, codigo_venta) {
            ...
            $.ajax({
                url:  "{{url('backoffice/tienda/sistema/'.$tienda->id.'/facturacionguiaremision/show-seleccionarventa')}}",
                type: 'GET',
                data: {
        ...
        function cargarventa_compra(iddocumento, codigo_compra) {
            ...
            $.ajax({
                url:  "{{url('backoffice/tienda/sistema/'.$tienda->id.'/facturacionguiaremision/show-seleccionarcompra')}}",
                type: 'GET',
                data: {
                    iddocumento:   iddocumento,
        ...
        function cargarventa_boletafactura(iddocumento, facturador_serie, facturador_correlativo){
            ...
            $.ajax({
                url:  "{{url('backoffice/tienda/sistema/'.$tienda->id.'/facturacionguiaremision/show-seleccionarboletafactura')}}",
                type: 'GET',
                data: {
                    iddocumento:            iddocumento,
...
$("#idproducto").select2({
    ...
    $.ajax({
        url:  "{{url('backoffice/tienda/sistema/'.$tienda->id.'/facturacionguiaremision/showseleccionarproducto')}}",
        type: 'GET',
        data: {
