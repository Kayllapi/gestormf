    ...
    <body>
            ...
            <div class="container-head">
                <div class="info-empresa-img txt-12 txt-center">
                    @if($facturacionnotacredito->agencialogo!='')
                        <img height="60px" src="{{ url('public/backoffice/tienda/'.$tienda->id.'/sistema/'.$facturacionnotacredito->agencialogo) }}"><br>
                    @endif
                    <span class="info-empresa-span-rz">{{ strtoupper($facturacionnotacredito->emisor_nombrecomercial) }}</span>
                    <span class="txt-grey">{{ strtoupper($facturacionnotacredito->emisor_direccion) }}</span>
                    <span class="txt-grey">{{ strtoupper($facturacionnotacredito->emisor_departamento.'/'.$facturacionnotacredito->emisor_provincia.'/'.$facturacionnotacredito->emisor_distrito) }}</span>
                </div>
                ...
                <div class="ruc">
                    <span class="text-ruc-serie">R.U.C: {{ $facturacionnotacredito->emisor_ruc }}</span>
                    <span class="text-tipo-documento">NOTA DE CRÉDITO</span>
                    <span  class="text-ruc-serie">{{$facturacionnotacredito->notacredito_serie}}-{{ str_pad($facturacionnotacredito->notacredito_correlativo, 8, "0", STR_PAD_LEFT) }}</span>
                </div>
            </div>
        </div>
        ...
        <div id="footer" class="txt-10 txt-center">
            <div class="container-img-txt">
                <img src="{{ url('public/backoffice/tienda/'.$tienda->id.'/sistema/'.$facturacionnotacredito->agencialogo) }}" height="30px">
            ...
            <div class="container-client">
                <table class="table txt-10" width="100%">
                    <tr>
                        ...
                        <td class="text-gray">{{ strtoupper($facturacionnotacredito->cliente_razonsocial) }}</td>
                    ...
                    <tr>
                        ...
                        <td class="text-gray">{{ $facturacionnotacredito->cliente_numerodocumento }}</td>
                        <td width="50px" class="text-black">IGV</td>
                        <td class="text-gray">18.00 %</td>
                    </tr>
                    <tr>
                        <td width="50px" class="text-black">Dirección:</td>
                        <td class="text-gray">{{ strtoupper($facturacionnotacredito->cliente_direccion) }}</td>
                        <!-- <td width="80px" class="text-black">Forma de Pago:</td>
                        <td class="text-gray"></td> -->
                    </tr>
                    <tr>
                        <td width="50px" class="text-black">Ciudad:</td>
                        <td class="text-gray">{{ strtoupper($facturacionnotacredito->cliente_departamento.'/'.$facturacionnotacredito->cliente_provincia.'/'.$facturacionnotacredito->cliente_distrito) }}</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="container-other">
                <table class="table txt-10" width="100%">
                    <tr>
                        ...
                        <td class="text-gray">{{ date_format(date_create($facturacionnotacredito->notacredito_fechaemision),"d/m/Y h:i:s A") }}</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="container-total">
                <table class="table txt-10" width="731px" cellspacing="0" style="margin-top: 20px;">
                    <tr>
                        ...
                        <th class="txt-right">{{ $facturacionnotacredito->notacredito_valorventa }}</th>
                    </tr>
                    <tr>
                        <th colspan="9" class="txt-right">IGV 18.00 %</th>
                        <th width="20px" class="txt-right">S/.</th>
                        <th class="txt-right">{{ $facturacionnotacredito->notacredito_totalimpuestos }}</th>
                    </tr>
                    <tr>
                        <th colspan="9" class="txt-right">TOTAL</th>
                        <th width="20px" class="txt-right">S/.</th>
                        <th class="txt-right">{{ $facturacionnotacredito->notacredito_montoimpuestoventa }}</th>
                    </tr>
                </table>
            </div>
            
            <div class="container-leyenda txt-10">
                <b>IMPORTE EN LETRAS:</b> {{ $facturacionnotacredito->leyenda_value }}
            </div>
