    ...
    <div class="custom-form">
        ...
        <div>
            <div class="row">
                <div class="col-sm-3"></div>
                <div class="col-sm-6">
                    <label>Boletas y Facturas *</label>
                    <select id="factura_boleta">
                      <option value=""></option>
                    </select>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" id="motivonotacredito_descripcion" onkeyup="texto_mayucula(this)"/>
                        </div>
                        <div class="col-sm-3"></div>
                    </div>
                </div>      
...
function cargarventa_boletafactura(idfactura){
...
function eliminarproducto(id){
 ...
 $('#factura_boleta').select2({
      placeholder: '-- Seleccionar --',
      ajax: {
        url:"{{url('backoffice/tienda/sistema/'.$tienda->id.'/facturacionnotacredito/show-boletasfacturas-fechaactual')}}",
        dataType: 'json',
        delay: 250,
        data: function (params) {
            return {
                  buscar: params.term,
                  idagencia: $('#idagencia option:selected').val(),
            };
        },
   ...
   cargarventa_boletafactura(e.currentTarget.value);
 });
</script>
@endsection