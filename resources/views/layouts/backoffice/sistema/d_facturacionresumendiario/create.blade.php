...
<script>
  ...
  placeholder: '-- Seleccionar --'
   ...
   let facturadorEstado      = $('#facturador_estado').val();
   ...
   cargarventa_boletafactura(facturadorEstado, $('#idagencia').val(), facturadorSerie, facturadorCorrelativo);
  ...
  $('#fechaemision').change(function (e) {
    ...
    $.ajax({
        url:  "{{url('backoffice/tienda/sistema/'.$tienda->id.'/facturacionresumendiario/show-seleccionarboletafactura-fecha')}}",
        type:'GET',
        data: {
...
function cargarventa_boletafactura(facturador_estado,idagencia,facturador_serie,facturador_correlativo){
  console.log( $('#seriecorrelativo option:selected').attr('tipodocumento'));
