          ...
          <div class="tabs-container" id="tab-carritocompra">
              ...
              <div class="tab">
                  ...
                  <div id="tab-carritocompra-2" class="tab-content" style="display: none;">
                      ...
                      <div class="mensaje-warning">
                        <i class="fa fa-warning"></i> Esta seguro de Anular la Venta</b>!.
                      </div>
                      <a href="javascript:;" onclick="anular_venta()" id="cont-btnventa" class="btn  big-btn  color-bg flat-btn mx-realizar-pago" style="float: left;width: 100%;">
                          Anular la Venta
                      </a>
<style>
#singleMap {
