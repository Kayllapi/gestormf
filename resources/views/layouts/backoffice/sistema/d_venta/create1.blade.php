                  ...
                  <div id="tab-carritocompra-0" class="tab-content" style="display: <?php echo $tienda->idcategoria==30? 'none':'block' ?>;">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div style="font-weight: bold;font-size: 14px;">Descuento:</div>
                          <input type="number" id="descuento_total" placeholder="0.00" onkeyup="calcularmonto()" style="font-weight: bold;text-align: center;" step="0.01">
                          <div style="font-weight: bold;font-size: 14px;">Total a Pagar:</div>
                          <input type="text" id="descuento_totalapagar" value="0.00" style="font-weight: bold;text-align: center;" disabled>
                          @endif
                        </div>    
                      </div> 
                      <div class="custom-form">
                  ...
                  <div id="tab-carritocompra-3" class="tab-content" style="display: none;">
                      <div class="row">
                        ...
                        <div class="col-md-6"> 
                            ...
                            <div id="cont-montorecibido" <?php echo (configuracion($tienda->id,'sistema_estadoventa')['valor']==1 or configuracion($tienda->id,'sistema_estadoventa')['valor']==2)? 'style="display:none;"':'' ?>>
                                <div class="row"> 
                                    <div class="col-md-6"> 
                                        <label>Total </label>
                            ...
                            @if(configuracion($tienda->id,'sistema_formapago')['valor']==1) 
                            @elseif(configuracion($tienda->id,'sistema_formapago')['valor']==2) 
                            ...
                            <div class="row"> 
                                <div class="col-md-6"> 
                                    <div id="cont-montorecibido" class="cont-montorecibido">
...
function agregarproducto(idproducto,codigo,imagen,nombre,precioalpublico,idtienda,tienda_link,tienda_nombre,cantidad=1,idestadodetalle,procedencia=''){
      ...
      var nuevaFila='<tr id="'+num+'" procedencia="'+procedencia+'" idestadodetalle="'+idestadodetalle+'" idproducto="'+idproducto+'" producto_codigo="'+codigo+'" producto_nombre="'+nombre+'" idtienda="'+idtienda+'" tienda_link="'+tienda_link+'" tienda_nombre="'+tienda_nombre+'" nombreproducto="'+codigo+' - '+nombre+'" style="'+style+'">';
