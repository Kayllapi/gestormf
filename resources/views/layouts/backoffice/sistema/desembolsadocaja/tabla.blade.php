<div class="modal-header">
  <h5 class="modal-title">Creditos Desembolsados Administrador</h5>
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="idasesor">
                                      ...
                                      $usuarios = DB::table('users')
                                          ...
                                          ->whereIn('users_permiso.idpermiso',[3,5,7])
...
<script>
  ...
  function show_data(e) {
   ...
   function exportar_pdf(){
      let url = "{{ url('backoffice/'.$tienda->id) }}/desembolsado/0/edit?view=exportar&fecha_inicio="+$('#fecha_inicio').val()+
