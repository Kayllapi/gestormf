...
<body>
  ...
  <div style="text-align: justify;">
    ...
    <br>
    <b>4.3.</b>	EL ACREEDOR queda facultada a refinanciar incluyendo el monto total de la deuda vencida, en una liquidación de saldo deudor conforme a sus reglas internas, como el importe del capital saldo por pagar más intereses, servicios, intereses compensatorios y moratorios más gastos y conforme tasas establecidas en la Hoja de Resumen del crédito. Bastando la intervención en dicha operación de cualquiera de los obligados y se tendrá como fecha de emisión el día de suscripción y de vencimiento el día en que se complete el pagaré, a partir del cual EL ACREEDOR queda facultada a exigir su pago en vía judicial, sin que sea obligatorio el protesto del mencionado título valor.   
    <br>
