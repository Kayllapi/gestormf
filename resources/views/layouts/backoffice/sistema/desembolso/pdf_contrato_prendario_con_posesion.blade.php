...
CON GARANTÍA MOBILIARIA CON POSESIÓN</title>
    <style>
      *{
...
<body>
  ...
  <div style="text-align: justify;">
    ...
    <b>4.3.</b> EL/LOS PRESTATARIO(S) manifiesta(n) bajo juramento, que es el único y legítimo propietario del (de los) bien(es) otorgado(s) 
    en Garantía Mobiliaria, numeral 4.1, realmente le corresponden y no contienen adulteraciones. De determinarse lo contrario a lo declarado 
...
<br><br>
      ...
      <div style="width:157px;margin-top: -55px;float:left;">
            @if($tienda->firma!='')
