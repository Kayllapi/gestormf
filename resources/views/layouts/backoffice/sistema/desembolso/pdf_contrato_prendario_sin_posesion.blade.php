...
<br>
    ...
    <b>2.3</b> EL/LOS PRESTATARIO(S) solicita(n) voluntariamente el servicio de recaudo de cuota a domicilio y/o negocio, y por ser un servicio alternativo autoriza(n) expresamente 
    no forme parte del costo financiero directo del crédito conforme Resolución SBS N° 3274-2017; asimismo EL/LOS PRESTATARIO(S) declara(n) conocer que dispone(n) de canal de pago 
...
<br>
    ...
    <b>3.1.</b> Al incumplimiento de pago de EL/LOS PRESTATARIO(S) sea el saldo o total del préstamo incluido intereses, gastos y comisión de servicio. 
    En créditos pagaderos hasta 2 meses de plazo y vencido, o en créditos pagaderos mayor a 2 meses de plazo, con 90 días a más de vencido la cuota de pago; 
    EL/LOS PRESTATARIO(S) tendrá(n) <b>{{ $credito->config_dias_tolerancia }}</b> días para su cancelación total o regularización, pagando custodia adicional de ser el caso del bien(s) en garantía, 
...
<b>4.5.</b> EL/LOS PRESTATARIO(S) manifiesta(n) bajo juramento, que es el único y legítimo propietario del (de los) bien(es) otorgado(s) en Garantía Mobiliaria, 
    ...
    intereses, gastos y comisión de servicio más los intereses compensatorios y moratorios de obligaciones impagas y gastos.<br>
