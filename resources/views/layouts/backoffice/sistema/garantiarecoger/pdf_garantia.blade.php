...
<body>
    <div class="ticket_contenedor">  
          ...
          <table class="tabla_informativa">
              <tr>
                  <td>
                    <b>N° PRÉSTAMO:</b> C{{ str_pad($creditocuenta, 8, "0", STR_PAD_LEFT) }}</td>
              </tr>
              <tr>
      ...
      <br><br>
          <table class="tabla_informativa">
              <tr>
                  <td style="text-align:left;">________________________________________<br><b>FIRMA DE CONFORMIDAD DE RECEPCIÓN:</b></td>
              </tr>
              <tr>
