<div class="modal-header">
  <h5 class="modal-title">Lista de Garantias Prend. por Entregar</h5>
...
<script>
  ...
  function lista_credito(){
    ...
    $.ajax({
      url:"{{url('backoffice/'.$tienda->id.'/garantiarecoger/showtable')}}",
      type:'GET',
      data: {
   ...
   function entregar(){
      ...
      let url = "{{ url('backoffice/'.$tienda->id) }}/garantiarecoger/"+idcredito_garantia+"/edit?view=entregar";
      modal({ route: url })
   }
