...
<form action="javascript:;" id="form_cambiar_estado">
    ...
    <div class="modal-header">
        <h5 class="modal-title">VOUCHER DE ENTREGA DE GARANTÍA</h5>
    ...
    <div class="modal-body">
       ...
       <div class="col-sm-12 mt-2">
        ...
        src="{{ url('/backoffice/'.$tienda->id.'/garantiarecoger/'.$credito_garantia->id.'/edit?view=pdf_garantia') }}#zoom=100" 
