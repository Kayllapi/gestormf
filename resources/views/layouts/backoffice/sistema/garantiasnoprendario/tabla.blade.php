<div class="modal-header">
    <h5 class="modal-title">
      ...
      <button type="button" class="btn btn-primary d-none" id="btn-create-cliente" onclick="load_create_garantianoprendaria()"><i class="fa-solid fa-plus"></i> NUEVA GARANTIA</button>
...
<div class="modal-body">
  <div class="row">
    <div class="col-sm-12 col-md-4">
      ...
      <label>Garantias No Prendarias: </label>
