<form action="javascript:;" 
    onsubmit="callback({
        route: '{{ url('backoffice/'.$tienda->id.'/gastoadministrativooperativo') }}',
        method: 'POST',
        data:{
            view: 'registrar'
        }
       ...
       <div class="row justify-content-center">
          <div class="col-sm-12 col-md-6">
              <div class="row">
                ...
                <!--label class="col-sm-3 col-form-label" style="text-align: right;">Fecha de Pago:</label>
                <div class="col-sm-3">
                  <input type="date" class="form-control" id="fechapago" value="{{now()->format('Y-m-d')}}">
                </div-->
              </div>
              <div class="row">
