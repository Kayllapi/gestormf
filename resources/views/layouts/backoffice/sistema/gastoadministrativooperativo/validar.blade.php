<form action="javascript:;" 
      onsubmit="callback({
          route: '{{ url('backoffice/'.$tienda->id.'/gastoadministrativooperativo/'.$idgastoadministrativooperativo) }}',
          method: 'PUT',
          data:{
              view: 'validar'
          }
      ...
      function(resultado){
          ...
          $('#modal-close-gastoadministrativooperativo-valid').click();
      },this)">
    <div class="modal-header">
        <h5 class="modal-title">Validar</h5>
        <button type="button" class="btn-close" id="modal-close-gastoadministrativooperativo-valid" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
        <label class="mt-1 modal-title">Aprobación</label>
              <div class="mb-1">
