...
<script>
    ...
    function valid_registro_retiro1(){
      ...
      function(resultado){
          ...
          modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero/0/edit?view=valid_registro_retiro1')}}&idfuenteretiro_retiro1="+idfuenteretiro_retiro1,  size: 'modal-sm'  });  
      })
    }
