...
<script>
    ...
    function valid_registro_retiro3(){
      ...
      function(resultado){
          ...
          modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero/0/edit?view=valid_registro_retiro3')}}&idfuenteretiro_retiro3="+idfuenteretiro_retiro3,  size: 'modal-sm'  });  
      })
    }
