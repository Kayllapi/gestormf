<form action="javascript:;" 
      ...
      function(resultado){
          ...
          $('#modal-close-movimientointernodinero-eliminar_retiro3').click();
      },this)">
    <div class="modal-header">
        <h5 class="modal-title">Eliminar</h5>
        <button type="button" class="btn-close" id="modal-close-movimientointernodinero-eliminar_retiro3" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
        ...
        <label class="mt-1" style="background-color: #636363;
          ...
          margin-bottom: 5px;">Aprobación</label>
              <div class="mb-1">
                  ...
                  <select class="form-select" id="idresponsable_retiro3">
                      <option value=""></option>
              ...
              <div class="mb-1">
                  ...
                  <input type="password" class="form-control" id="responsableclave_retiro3">
              </div>
    </div>
...
<script>
    sistema_select2({ input:'#idresponsable_retiro3' });
</script> 