...
<script>
    ...
    function eliminar_movimientointernodinero_deposito1(){
      modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero/'.$movimientointernodinero->id.'/edit?view=eliminar_deposito1')}}",  size: 'modal-sm'  });  
    }

    function valid_registro_deposito1(id){
      var idfuenteretiro_deposito1 = $('#idfuenteretiro_deposito1').val();
      modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero')}}/"+id+"/edit?view=valid_registro_deposito1&idfuenteretiro_deposito1="+idfuenteretiro_deposito1,  size: 'modal-sm'  });
    }
</script>