...
<script>
  ...
  function eliminar_movimientointernodinero_deposito3(){
    modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero/'.$movimientointernodinero->id.'/edit?view=eliminar_deposito3')}}",  size: 'modal-sm'  });  
  }
    function valid_registro_deposito3(id){
      var idfuenteretiro_deposito3 = $('#idfuenteretiro_deposito3').val();
      modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero')}}/"+id+"/edit?view=valid_registro_deposito3&idfuenteretiro_deposito3="+idfuenteretiro_deposito3,  size: 'modal-sm'  });
    }
</script>