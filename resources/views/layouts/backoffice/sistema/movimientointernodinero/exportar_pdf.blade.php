            ...
            <table style="width:100%;">
              <thead class="table-dark">
                <tr>
                  ...
                  <td style="border-top: 2px solid #000;border-bottom: 2px solid #000;text-align:center;font-weight: bold;">N° operación (banco)</td>
                  <td style="border-top: 2px solid #000;border-bottom: 2px solid #000;text-align:center;font-weight: bold;">Descripción</td>
                  <td style="border-top: 2px solid #000;border-bottom: 2px solid #000;text-align:center;width:130px;font-weight: bold;">Fecha</td>
                  <td style="border-top: 2px solid #000;border-bottom: 2px solid #000;text-align:center;width:60px;font-weight: bold;">Usuario</td>
                </tr>
              </thead>
              <tbody>
