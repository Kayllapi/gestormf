...
<script>
  ...
  function load_nuevo_movimientointernodinero_retiro1(){
    pagina({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero/create?view=registrar_retiro1')}}", result:'#form-result-giro_retiro1'});
  }
  function show_data_retiro1(e) {
    let id = $(e).attr('data-valor-columna');
    $('tr.selected').removeClass('selected');
    $(e).addClass('selected');
    pagina({ route:"{{url('backoffice')}}/{{$tienda->id}}/movimientointernodinero/"+id+"/edit?view=editar_retiro1", result:'#form-result-giro_retiro1'});
  }
  ...
  function load_nuevo_movimientointernodinero_deposito1(){
    pagina({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero/create?view=registrar_deposito1')}}", result:'#form-result-giro_deposito1'});
  }
  function show_data_deposito1(e) {
    let id = $(e).attr('data-valor-columna');
    $('tr.selected').removeClass('selected');
    $(e).addClass('selected');
    pagina({ route:"{{url('backoffice')}}/{{$tienda->id}}/movimientointernodinero/"+id+"/edit?view=editar_deposito1", result:'#form-result-giro_deposito1'});
  }
  ...
  function load_nuevo_movimientointernodinero_retiro3(){
    pagina({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero/create?view=registrar_retiro3')}}", result:'#form-result-giro_retiro3'});
  }
  function show_data_retiro3(e) {
    let id = $(e).attr('data-valor-columna');
    $('tr.selected').removeClass('selected');
    $(e).addClass('selected');
    pagina({ route:"{{url('backoffice')}}/{{$tienda->id}}/movimientointernodinero/"+id+"/edit?view=editar_retiro3", result:'#form-result-giro_retiro3'});
  }
  ...
  function load_nuevo_movimientointernodinero_deposito3(){
    pagina({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero/create?view=registrar_deposito3')}}", result:'#form-result-giro_deposito3'});
  }
  function show_data_deposito3(e) {
    let id = $(e).attr('data-valor-columna');
    $('tr.selected').removeClass('selected');
    $(e).addClass('selected');
    pagina({ route:"{{url('backoffice')}}/{{$tienda->id}}/movimientointernodinero/"+id+"/edit?view=editar_deposito3", result:'#form-result-giro_deposito3'});
  }
  
   function exportar_pdf(){
      let url = "{{ url('backoffice/'.$tienda->id) }}/movimientointernodinero/0/edit?view=exportar&fechainicio="+$('#fechainicio').val()+
          "&fechafin="+$('#fechafin').val();
      modal({ route: url,size:'modal-fullscreen' })
   }
  
  function valid_reporte(){
    modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodinero/0/edit?view=valid_reporte')}}",  size: 'modal-sm'  });  
  }
</script>
