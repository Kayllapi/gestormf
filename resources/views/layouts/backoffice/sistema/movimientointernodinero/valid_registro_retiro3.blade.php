<form action="javascript:;" 
      onsubmit="callback({
          route: '{{ url('backoffice/'.$tienda->id.'/movimientointernodinero/0') }}',
          method: 'PUT',
          data:{
              view: 'valid_registro_retiro3'
          }
      },
      function(resultado){
          $('#idresponsable_retiro3').val(resultado.idresponsable);
          $('#idresponsable_permiso_retiro3').val($('#idresponsable :selected').attr('idpermiso'));
          submit_registro_retiro3();
