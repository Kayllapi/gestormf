...
<script>
    ...
    $("#idfuenteretiro_deposito2").on("change", function(e) {
      ...
      callback({
          route: '{{ url('backoffice/'.$tienda->id.'/movimientointernodineroinsti') }}',
          method: 'POST',
      ...
      function(resultado){
          ...
          modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodineroinsti/0/edit?view=valid_registro_deposito2')}}&idfuenteretiro_deposito2="+idfuenteretiro_deposito2,  size: 'modal-sm'  });  
      })
    }
