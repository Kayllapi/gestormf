...
<script>
    ...
    function valid_registro_retiro2(){
      ...
      function(resultado){
          ...
          modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodineroinsti/0/edit?view=valid_registro_retiro2')}}&idfuenteretiro_retiro2="+idfuenteretiro_retiro2,  size: 'modal-sm'  });  
      })
    }
