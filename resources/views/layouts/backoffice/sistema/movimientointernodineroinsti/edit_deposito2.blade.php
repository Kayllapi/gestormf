...
<script>
  ...
  function eliminar_movimientointernodinero_deposito2(){
    modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodineroinsti/'.$movimientointernodinero->id.'/edit?view=eliminar_deposito2')}}",  size: 'modal-sm'  });  
  }

    function valid_registro_deposito2(id){
      var idfuenteretiro_deposito2 = $('#idfuenteretiro_deposito2').val();
      modal({ route:"{{url('backoffice/'.$tienda->id.'/movimientointernodineroinsti')}}/"+id+"/edit?view=valid_registro_deposito2&idfuenteretiro_deposito2="+idfuenteretiro_deposito2,  size: 'modal-sm'  });
    }
</script>