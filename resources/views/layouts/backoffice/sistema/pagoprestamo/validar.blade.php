<form action="javascript:;" 
      onsubmit="callback({
          route: '{{ url('backoffice/'.$tienda->id.'/pagoprestamo/'.$idcredito_cobranzacuota) }}',
          method: 'PUT',
          data:{
              view: 'validar'
          }
      ...
      function(resultado){
          lista_credito();
          $('#modal-close-pagoprestamo-valid').click();
      },this)">
    <div class="modal-header">
        <h5 class="modal-title">Validar</h5>
        <button type="button" class="btn-close" id="modal-close-pagoprestamo-valid" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
