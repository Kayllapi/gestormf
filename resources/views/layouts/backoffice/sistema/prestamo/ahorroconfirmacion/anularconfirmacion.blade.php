...
<div id="carga-ahorro">
    <div class="tabs-container" id="tab-confirmacion">
         <ul class="tabs-menu">
             <li class="current"><a href="#tab-confirmacion-1">Confirmación</a></li>
             <li><a href="#tab-confirmacion-2">Detalle de Ahorro</a></li>
         </ul>
         <div class="tab">
            <div id="tab-confirmacion-1" class="tab-content" style="display: block;">
                <form action="javascript:;"
                    ...
                    <div class="mensaje-warning">
                        ...
                        <b>¿Esta seguro de Anular el Confirmación?</b><br>          
                    </div>
                    <button type="submit" class="btn mx-btn-post"><i class="fa fa-ban"></i> Anular Confirmación</button>
                </form>    
            </div>
            <div id="tab-confirmacion-2" class="tab-content" style="display: none;">
