...
<script>
  function mostrarDocumento(iddocumento) {
    $('#load-documento').html('<iframe src="{{ url('backoffice/tienda/sistema/'.$tienda->id.'/prestamo/ahorroconfirmacion/'.$prestamoahorro->id.'/edit?view=documentopdf&iddocumento=') }}'+iddocumento+'" frameborder="0" width="100%" height="600px"></iframe>');
  }
</script>
@endsection