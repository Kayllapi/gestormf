<div class="col-sm-6">
    <div class="tabs-container" id="tab-ahorro">
        <ul class="tabs-menu">
            <li class="current"><a href="#tab-ahorro-0">Detalle</a></li>
            <li><a href="#tab-ahorro-1">Facturación</a></li>
        </ul>
        <div class="tab">
            <div id="tab-ahorro-0" class="tab-content" style="display: block;">
              @if($s_prestamo_ahorro->idprestamo_tipoahorro==1)
                  <div class="row">
                    <div class="col-sm-6">
                        <label>Total Ganancia</label>
                        <input type="number" id="totalganancia" placeholder="0.00" min="0" step="0.01" disabled>
                        <label>Total Redondeado</label>
                        <input type="number" id="totalgananciaredondeado" placeholder="0.00" min="0" step="0.01" disabled>
                    </div>
                    <div class="col-sm-6">
                        <label>Retirar Ganancia *</label>
                        <input type="number" id="retirarganancia" placeholder="0.00" min="0" step="0.01">
                    </div>
                  </div>
              ...
              @elseif($s_prestamo_ahorro->idprestamo_tipoahorro==3)
                          ...
                          <input type="number" id="cuotas_totalredondeado" min="0" onkeyup="calcular_montoformapago()" step="0.01">
                  <table class="table" id="tabla-formapago" style="margin-bottom: 3px;">
                    <thead>
                      <tr style="background: #31353d; color: #fff;">
                        <th style="padding: 8px;">Depósito</th>
            ...
            <div id="tab-ahorro-1" class="tab-content" style="display: none;">
                    ...
                    <div class="row">
                       <div class="col-md-12">
                          <select id="facturacion_idcliente">
                              <option value="{{ $s_prestamo_ahorro->idcliente }}">{{ $s_prestamo_ahorro->cliente }}</option>
                          </select>
                       </div>
                    </div>
                    <label>Dirección *</label>
                    <input type="text" id="facturacion_direccion" value="{{ $s_prestamo_ahorro->cliente_direccion }}"/>
                    <label>Ubicación (Ubigeo) *</label>
                    <select id="facturacion_idubigeo">
                        <option value="{{ $s_prestamo_ahorro->idubigeo }}">{{ $s_prestamo_ahorro->ubigeo }}</option>
                    </select>
                </div>
                <div class="col-sm-6">
                  <label>Agencia *</label>
    ...
    <button type="button" class="btn mx-btn-post" onclick="registrar_prestamo()" style="margin-bottom: 5px;">Registrar Recaudacion</button>
</div>  
<div class="col-sm-6">
    <div class="tabs-container" id="tab-tablerecaudacion">
        <ul class="tabs-menu">
          
          @if($s_prestamo_ahorro->idprestamo_tipoahorro==1 && $s_prestamo_ahorro->idprestamo_tipoahorro==2)
            <li class="current"><a href="#tab-tablerecaudacion-0">Pendientes</a></li>
            <li><a href="#tab-tablerecaudacion-1">Cancelados</a></li>
            <li><a href="#tab-tablerecaudacion-2">Recaudaciones</a></li>
            <li><a href="#tab-tablerecaudacion-3">Resumen</a></li>
          @elseif($s_prestamo_ahorro->idprestamo_tipoahorro==3)
            <li class="current"><a href="#tab-tablerecaudacion-2">Recaudaciones</a></li>
            <li><a href="#tab-tablerecaudacion-4">Retiros</a></li>
          @endif
        </ul>
        <div class="tab">
            <div id="tab-tablerecaudacion-0" class="tab-content" style="display: block;">
                <div id="cont-recaudacionpendiente"></div>
            </div>
            <div id="tab-tablerecaudacion-1" class="tab-content" style="display: none;">
                <div id="cont-recaudacioncancelada"></div>
            </div>
            <div id="tab-tablerecaudacion-2" class="tab-content" style="{{$s_prestamo_ahorro->idprestamo_tipoahorro==3?'display: block;':'display: none;'}}">
                <div id="cont-pagorealizado"></div>
            </div>
            <div id="tab-tablerecaudacion-4" class="tab-content" style="display: none;">
                <div id="cont-retirorealizado"></div>
            </div>
            <div id="tab-tablerecaudacion-3" class="tab-content" style="display: none;">
                <div class="tabs-container" id="tab-resumenahorro">
                      <ul class="tabs-menu">
                          <li class="current"><a href="#tab-resumenahorro-0" id="tab-resumen">Ahorro</a></li>
                          <li><a href="#tab-resumenahorro-1" id="tab-actual">Recaudación Pagada</a></li>
                          <li><a href="#tab-resumenahorro-2" id="tab-restante">Recaudación Vencida</a></li>
                          <li><a href="#tab-resumenahorro-3" id="tab-pagado">Recaudación Restante</a></li>
                          <li><a href="#tab-resumenahorro-4" id="tab-pagado">Recaudación Pendiente</a></li>
                      </ul>
                      <div class="tab">
                          <div id="tab-resumenahorro-0" class="tab-content" style="display: block;">
                              <div class="row">
                                  <div class="col-md-6">
                          ...
                          <div id="tab-resumenahorro-1" class="tab-content" style="display none;">
                              <div class="row">
                                  <div class="col-md-6">
                          ...
                          <div id="tab-resumenahorro-2" class="tab-content" style="display none;">
                              <div class="row">
                                  <div class="col-md-6">
                                      <label>Total Atrasos</label>
                          ...
                          <div id="tab-resumenahorro-3" class="tab-content" style="display none;">
                              <div class="row">
                                  <div class="col-md-6">
                                      <label>Total Atrasos</label>
                          ...
                          <div id="tab-resumenahorro-4" class="tab-content" style="display none;">
                              <div class="row">
                                  <div class="col-md-6">
                                      <label>Total Atrasos</label>
...
<script>
    ...
    tab({click:'#tab-ahorro'});
    tab({click:'#tab-resumenahorro'});
...
@if($s_prestamo_ahorro->idprestamo_tipoahorro==1)
    ...
    mostrar_cuotapendiente_fijo();
    function mostrar_cuotapendiente_fijo(){
        $.ajax({
            url:  "{{ url('backoffice/tienda/sistema/'.$tienda->id.'/prestamo/ahorrorecaudacion/'.$s_prestamo_ahorro->id.'/edit') }}",
            type: 'GET',
            data: {
                view: 'cuotapendiente',
            },
            beforeSend: function (data) {
                load('#cont-recaudacionpendiente');
            },
            success: function (res) {
                $('#cont-recaudacionpendiente').html(res);
...
@elseif($s_prestamo_ahorro->idprestamo_tipoahorro==2)
    ...
    function mostrar_ahorrocliente(){
    ...
    function mostrar_cuotacancelada(){
        $.ajax({
            ...
            beforeSend: function (data) {
                load('#cont-recaudacioncancelada');
            },
            success: function (res) {
                $('#cont-recaudacioncancelada').html(res);
            }
        });
    }
@elseif($s_prestamo_ahorro->idprestamo_tipoahorro==3)
...
@endif
    function mostrar_pagorealizado(){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrorecaudacion/{{ $s_prestamo_ahorro->id }}/edit?view=pagorealizado',result:'#cont-pagorealizado'});
    }
    function ticket_pagorealizado(idrecaudacion){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrorecaudacion/{{ $s_prestamo_ahorro->id }}/edit?view=pagorealizadoticket&idrecaudacion='+idrecaudacion+'&idprestamo_tipoahorro={{ $s_prestamo_ahorro->idprestamo_tipoahorro }}',result:'#cont-pagorealizado'});
    }
    function detalle_pagorealizado(idrecaudacion){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrorecaudacion/{{ $s_prestamo_ahorro->id }}/edit?view=pagorealizadodetalle&idrecaudacion='+idrecaudacion,result:'#cont-pagorealizado'});
    }
    function anular_pagorealizado(idrecaudacion){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrorecaudacion/{{ $s_prestamo_ahorro->id }}/edit?view=pagorealizadoanular&idrecaudacion='+idrecaudacion,result:'#cont-pagorealizado'});
    }
    function mostrar_retirorealizado(){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrorecaudacion/{{ $s_prestamo_ahorro->id }}/edit?view=retirorealizado',result:'#cont-retirorealizado'});
    }
    function registrar_retirorealizado(){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrorecaudacion/{{ $s_prestamo_ahorro->id }}/edit?view=retirorealizadoregistrar',result:'#cont-retirorealizado'});
    }
    function ticket_retirorealizado(idrecaudacion){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrorecaudacion/{{ $s_prestamo_ahorro->id }}/edit?view=retirorealizadoticket&idrecaudacion='+idrecaudacion,result:'#cont-retirorealizado'});
    }
    function detalle_retirorealizado(idrecaudacion){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrorecaudacion/{{ $s_prestamo_ahorro->id }}/edit?view=retirorealizadodetalle&idrecaudacion='+idrecaudacion,result:'#cont-retirorealizado'});
    }
    function anular_retirorealizado(idrecaudacion){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrorecaudacion/{{ $s_prestamo_ahorro->id }}/edit?view=retirorealizadoanular&idrecaudacion='+idrecaudacion,result:'#cont-retirorealizado'});
    }
    ...
    function calcular_montoformapago(){
        ...
        if(typeof cuotas_totalabono !== 'undefined'){
            cuotas_totalabono = 0;
        }
    ...
    function registrar_prestamo() {
        callback({
            ...
            data:   {
                ...
                idprestamo_tipoahorro: {{$s_prestamo_ahorro->idprestamo_tipoahorro}},
                cuotas_totalredondeado: $('#cuotas_totalredondeado').val(),
                @if($s_prestamo_ahorro->idprestamo_tipoahorro==1)
                retirarganancia: $('#retirarganancia').val(),
                @endif
        ...
        function(resultado){
          $('#modal-recaudacionrealizada').css('display','block');
          var imprimir = '';
          imprimir = '<div id="iframeventa"><iframe src="{{ url('backoffice/tienda/sistema/'.$tienda->id.'/prestamo/ahorrorecaudacion') }}/'+resultado['idprestamorecaudacion']+'/edit?view=ticketpdf&idrecaudacion='+resultado['idprestamorecaudacion']+'&idprestamo_tipoahorro='+resultado['idprestamo_tipoahorro']+'#zoom=130" frameborder="0" width="100%" height="600px"></iframe></div>';
          $('#contenido-recaudacionrealizada').html('<div class="cont-confirm" style="margin-top: 15px;">'+
                             ...
                             '<div class="custom-form" style="text-align: center;margin-bottom: 5px;">'+
                             '<button type="button" class="btn big-btn color-bg flat-btn" style="margin: auto;float: none;" onclick="irarecaudacions()">'+
    ...
    function realizar_nueva_recaudacion() {
      ...
      $('#modal-recaudacionrealizada').css('display','none');
    }
    function irarecaudacions() {
