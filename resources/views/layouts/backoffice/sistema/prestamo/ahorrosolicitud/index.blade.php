...
<div class="list-single-main-wrapper fl-wrap">
  <div class="breadcrumbs gradient-bg fl-wrap">
    <span>Solicitudes de Ahorro</span>
    <a class="btn btn-warning" href="{{ url('backoffice/tienda/sistema/'.$tienda->id.'/prestamo/ahorrosolicitud/create') }}"><i class="fa fa-angle-right"></i> Registrar</a>
  </div>
</div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="header-user-menu menu-option" id="menu-opcion">
                          ...
                          <ul>
                          @if($value->idestadoahorro==1)
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrosolicitud/{{$value->id}}/edit?view=editar"><i class="fa fa-edit"></i> Editar</a></li>
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrosolicitud/{{$value->id}}/edit?view=preaprobar"><i class="fa fa-check"></i> Pre Aprobar</a></li>
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrosolicitud/{{$value->id}}/edit?view=eliminar"><i class="fa fa-trash"></i> Eliminar</a></li>
                          @elseif($value->idestadoahorro==2)
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrosolicitud/{{$value->id}}/edit?view=detalle"><i class="fa fa-list"></i> Detalle</a></li>
                          @elseif($value->idestadoahorro==3)
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrosolicitud/{{$value->id}}/edit?view=detalle"><i class="fa fa-list"></i> Detalle</a></li>
                          @elseif($value->idestadoahorro==4)
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamo/ahorrosolicitud/{{$value->id}}/edit?view=detalle"><i class="fa fa-list"></i> Detalle</a></li>
