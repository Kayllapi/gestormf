...
@include('app.sistema.cabecera',[
    ...
    'botones'=>[
        'atras:/'.$tienda->id.'/prestamoampliacion: Ir Atras'
    ]
])
  <div class="row">
    <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                @if($s_prestamo_credito->total_abono>0)
                <label>Abono</label>
                <input type="text" id="total_abono" value="{{ $s_prestamo_credito->total_abono }}" disabled/>
                @endif
        ...
        <tbody>
          @foreach ($s_prestamo_creditodetalle as $value)
            <tr>
              ...
              @if($s_prestamo_credito->total_abono>0)
              <td style="padding: 8px;text-align: right;">{{ $value->abono }}</td>
              @endif
            </tr>
          @endforeach
          <tr style="background-color: #31353c;color: white;">
            ...
            @if($s_prestamo_credito->total_abono>0)
            <td style="padding: 8px;text-align: right;">{{ $s_prestamo_credito->total_abono }}</td>
            @endif
          </tr>
        </tbody>
      </table>
