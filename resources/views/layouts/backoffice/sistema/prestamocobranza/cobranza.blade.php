            ...
            <div id="tab-credito-0" class="tab-content" style="display: block;">
                  <div class="row">
                    <div class="col-sm-4">
                          ...
                          @if(configuracion($tienda->id,'prestamo_estadodescuentointeres')['valor']==1 && configuracion($tienda->id,'usuario_estadodescuentointeres',Auth::user()->id)['valor']==1)
                          ...
                          <label>Descontar Interes *</label>
                          <input type="number" id="cuotas_total_descuentointeres" placeholder="0.00" onclick="mostrar_creditocliente()" onkeyup="mostrar_creditocliente()">
                          </div>
                          @endif
                    </div>
                    <div class="col-sm-4">
...
<div class="col-sm-6">
    <div class="tabs-container" id="tab-tablecobranza">
        <ul class="tabs-menu">
            ...
            <li><a href="#tab-tablecobranza-4">Garantias</a></li>
            @endif
            <li><a href="#tab-tablecobranza-3">Resumen</a></li>
            <li><a href="#tab-tablecobranza-5">Documentos</a></li>
        </ul>
        <div class="tab">
            <div id="tab-tablecobranza-0" class="tab-content" style="display: block;">
                <div id="cont-cobranzapendiente" style="overflow-x: auto;"></div>
            </div>
            <div id="tab-tablecobranza-1" class="tab-content" style="display: none;">
                <div id="cont-cobranzacancelada" style="overflow-x: auto;"></div>
            </div>
            <div id="tab-tablecobranza-2" class="tab-content" style="display: none;">
                <div id="cont-pagorealizado" style="overflow-x: auto;"></div>
            </div>
                          ...
                          <div id="tab-resumencredito-0" class="tab-content" style="display: block;">
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <input type="text" id="resumen-desembolso-fechadesembolso" disabled>
                          ...
                          <div id="tab-resumencredito-2" class="tab-content" style="display none;">
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <label>Total Acuenta</label>
                                      <input type="text" id="resumen-vencida-acuenta" value="0.00" disabled>
                                  </div>
                                  <label style="text-align: center;">Total a Pagar</label>
            ...
            <div id="tab-tablecobranza-4" class="tab-content" style="display: none;">
                <div id="cont-garantias" style="overflow-x: auto;"></div>
            </div>
            <div id="tab-tablecobranza-5" class="tab-content" style="display: none;">
              <div id="cont-documento"></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function calcular_montoformapago(){
        ...
        if(idtipopago==2){
            ...
            efectivo = montocompleto+cuotas_totalabono;
        }
    ...
    function mostrar_cuotapendiente(){
        $.ajax({
            ...
            data: {
                ...
                descuentointeres: $('#cuotas_total_descuentointeres').val(),
    ...
    function mostrar_garantias(){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamocobranza/{{ $s_prestamo_credito->id }}/edit?view=garantias',result:'#cont-garantias'});
    }
    function devolver_garantias(idbien){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamocobranza/{{ $s_prestamo_credito->id }}/edit?view=garantiasdevolver&idbien='+idbien,result:'#cont-garantias'});
    }
    function rematar_garantias(idbien){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamocobranza/{{ $s_prestamo_credito->id }}/edit?view=garantiasrematar&idbien='+idbien,result:'#cont-garantias'});
    }
    ...
    documento_index();
    function documento_index(){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamocobranza/{{ $s_prestamo_credito->id }}/edit?view=documento',result:'#cont-documento'});
    }
</script>