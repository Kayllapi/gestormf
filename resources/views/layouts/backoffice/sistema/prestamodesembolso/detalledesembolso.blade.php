                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                  ...
                                  <input type="text" value="{{date_format(date_create($prestamodesembolso->fecharegistro), "d/m/Y h:i:s A")}}" disabled/>
                                  <label>Fecha de Aprobación</label>
                                  <input type="text" value="{{date_format(date_create($prestamodesembolso->fechapreaprobado), "d/m/Y h:i:s A")}}" disabled/>
                                </div>
                                <div class="col-sm-6">
                                  <label>Fecha de Desembolso</label>
                                  <input type="text" value="{{date_format(date_create($prestamodesembolso->fechadesembolsado), "d/m/Y h:i:s A")}}" disabled/>
                                  <label>Asesor</label>
