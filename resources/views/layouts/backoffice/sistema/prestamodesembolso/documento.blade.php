...
<script>
  function mostrarDocumento(iddocumento) {
    ...
    load('#iframe-carga'); 
    $('#load-documento').html('<iframe onload="iframeload();" src="{{ url('backoffice/tienda/sistema/'.$tienda->id.'/prestamodesembolso/'.$prestamodesembolso->id.'/edit?view=documentopdf&iddocumento=') }}'+iddocumento+'" frameborder="0" width="100%" height="600px"></iframe>');
  }
function iframeload(){
    $('#iframe-carga').html('');
}    
