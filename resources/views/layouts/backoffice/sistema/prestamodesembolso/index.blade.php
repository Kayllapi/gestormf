                      ...
                      <div class="header-user-menu menu-option" id="menu-opcion">
                          ...
                          @elseif($value->idestadocredito==4)
                            ...
                            @else
                              ...
                              @endif
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamodesembolso/{{$value->id}}/edit?view=ticket"><i class="fa fa-ticket-alt"></i> Ticket de Desembolso</a></li>
                              @if($value->facturacion_montorecibido>0)
                              <li><a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamodesembolso/{{$value->id}}/edit?view=ticketgastoadministrativo"><i class="fa fa-ticket-alt"></i> Ticket de Gasto Administrativo</a></li>
                              @endif
