        ...
        <tr>
          ...
          <th width = '10px'></th>
              ...
              @include('app.tablesearch',[
                  ...
                  'search_url'=> url('backoffice/tienda/sistema/'.$tienda->id.'/prestamomorasolicitud')
              ])
      <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="header-user-menu menu-option" id="menu-opcion">
                  ...
                  <ul>
                  @if ($value->idestadocobranza == 1)
                      <li><a href="{{ url('backoffice/tienda/sistema/'.$tienda->id.'/prestamomorasolicitud/'.$value->id.'/edit?view=confirmar') }}"><i class="fa fa-check"></i> Revisar</a></li>
                  @elseif ( $value->idestadocobranza == 2)
