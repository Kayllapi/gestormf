    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="date" value="{{$s_prestamo_credito->fechainicio}}" id="fechainicio" onchange="mostrar_credito_reprogramado()"/>
              ...
              <textarea id="reprogramar_motivo" style="height:85px;" onkeyup="texto_mayucula(this)">{{$s_prestamo_credito->motivo}}</textarea>
        </div>
        <div class="col-md-6">
                  ...
                  <div class="fuzone" id="cont-reprogramar_documento">
                      ...
                      <input type="hidden" id="reprogramar_documento_anterior">
                  </div>
...
<script>
  ...
  function mostrar_documento(archivo,imagen=''){
          ...
          $('#reprogramar_documento_anterior').val(imagen);
  }
