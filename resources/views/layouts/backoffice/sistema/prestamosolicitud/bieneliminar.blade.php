                        ...
                        <form action="javascript:;" 
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" value="{{$prestamobien->producto}}" id="bien_editar_producto" disabled>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" value="{{$prestamobien->valorestimado}}" id="bien_detalle_valorestimado" min="0" step="0.01" disabled>
                                    ...
                                    <select id="bien_editar_idprestamo_documento" disabled>
                                        <option></option>
                            ...
                            <button type="submit" class="btn mx-btn-post">Eliminar Garantia</button>
                        </form>
<script>
