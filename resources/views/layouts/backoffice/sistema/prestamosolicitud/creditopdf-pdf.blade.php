...
<body>
    ...
    <div class="content">
        ...
        <table class="tabla">
            ...
            <tr>
              <td class="tabla_titulo" style="height:15px;">TIPO DE CRÉDITO</td>
              <td colspan="7">
                <?php echo $prestamocredito->tipocredito ?> - <?php echo $prestamocredito->tipocreditogenerado ?>
              </td>
            </tr>
            <tr>
        ...
        <table class="tabla">
            ...
            <?php
            $comentario = explode('/&/comentario/&/',$prestamocredito->comentariosupervisor);
            ...
            <tr>
              @if($i==0)
              <td class="tabla_titulo" rowspan="{{count($comentario)}}" colspan="2">COMENTARIOS/OBSERVACIONES</td>
              @endif
