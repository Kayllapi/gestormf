            ...
            <tr>
              ...
              <td>
                  ...
                  @elseif($pagoservicio==3)
                      ...
                      <?php $valor = $valor+3; ?>   
                      <?php $numvalor = 3; ?>     
                  @elseif($pagoservicio>4)
                      DEUDA POR MÀS DE 2 MESES
                      <?php $valor = $valor+2; ?>   
                      <?php $numvalor = 2; ?>   
                  @else
                      ---
        ...
        <table class="tabla">
            <tr class="tabla_cabera">
              ...
              <tr>
                ...
                <td class="tabla_titulo" style="width:100px">PERSONA</td>
                <td colspan="3">{{ $referencia1!=''?$referencia1->completo_persona:'' }}</td>
              </tr>
              <tr>
                <td class="tabla_titulo">TELÉFONO</td>
                <td>{{ $referencia1!=''?$referencia1->numerotelefono:'' }}</td>
                <td class="tabla_titulo" style="width:80px">RELACIÓN</td>
              ...
              <tr>
                ...
                <td class="tabla_titulo" style="width:100px">PERSONA</td>
                <td colspan="3">{{ $referencia2!=''?$referencia2->completo_persona:'' }}</td>
              </tr>
              <tr>
                <td class="tabla_titulo">TELÉFONO</td>
              ...
              <tr>
                ...
                <td class="tabla_titulo" style="width:100px">PERSONA</td>
                <td colspan="3">{{ $referencia3!=''?$referencia3->completo_persona:'' }}</td>
              </tr>
              <tr>
                <td class="tabla_titulo">TELÉFONO</td>
              ...
              <tr>
                ...
                <td class="tabla_titulo" style="width:100px">PERSONA</td>
                <td colspan="3">{{ $referencia4!=''?$referencia4->completo_persona:'' }}</td>
              </tr>
              <tr>
                <td class="tabla_titulo">TELÉFONO</td>
              ...
              <tr>
                ...
                <td class="tabla_titulo" style="width:100px">PERSONA</td>
                <td colspan="3">{{ $referencia5!=''?$referencia5->completo_persona:'' }}</td>
              </tr>
              <tr>
                <td class="tabla_titulo">TELÉFONO</td>
