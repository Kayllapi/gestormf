...
<div id="carga-credito">
    ...
    <div class="tabs-container" id="tab-detalle-cliente">
        <ul class="tabs-menu">
              ...
              <li><a href="#tab-detalle-cliente-4">Sustento</a></li>
              <li><a href="#tab-detalle-cliente-5">Resultado</a></li>
        </ul>
        <div class="tab">
              ...
              <form action="javascript:;"
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                        ...
                        <table style="margin-bottom: 5px;">
                          <tr>
                            ...
                            <td>
                              <div class="onoffswitch">
                                  <input type="checkbox" class="onoffswitch-checkbox check_estadocreditogrupal" id="check_estadocreditogrupal" <?php echo $prestamocredito->idprestamo_estadocredito==2?'checked="true"':'' ?>>
                        ...
                        <div id="cont-estadocreditogrupal0" <?php echo $prestamocredito->idprestamo_estadocredito==1?'style="display: none;"':'' ?> >
                        <div class="row">
                            <div class="col-md-4">
                                <label>Monto *</label>
                                <input type="number" value="{{$prestamocredito->monto}}" id="montogrupal" min="0" step="0.01"/>
                          </div>
                        </div>
                        </div> 
                        <div id="cont-estadocreditogrupal1" <?php echo $prestamocredito->idprestamo_estadocredito==2?'style="display: none;"':'' ?>>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="number" value="{{$prestamocredito->numerocuota==0?'':$prestamocredito->numerocuota}}" id="numerocuota" min="0" step="1" onkeyup="creditoCalendario()" onclick="creditoCalendario()"/>
                                <label>Fecha de Inicio *</label>
                                <input type="date" value="{{($prestamocredito->fechainiciocero=='0000-00-00' or $prestamocredito->fechainiciocero=='2000-01-01')?'':$prestamocredito->fechainiciocero}}" id="fechainicio" onchange="creditoCalendario()" onclick="creditoCalendario()"/>
                            ...
                            <div class="col-md-4">
                                ...
                                <label>Interes % *</label>
                                <input type="number" value="{{$prestamocredito->tasa==0?'':$prestamocredito->tasa}}" id="tasa" min="0" step="0.001" onclick="creditoCalendario()" onkeyup="creditoCalendario()"/>
                                @if(configuracion($tienda->id,'prestamo_estadoabono')['valor']=='on')
                                <label>Abono *</label>
                                <input type="number" id="abono" value="{{$prestamocredito->total_abono==0?'':$prestamocredito->total_abono}}" min="0" step="0.01" onclick="creditoCalendario()" onkeyup="creditoCalendario()"/>
                                @endif
                    ...
                    <div class="col-sm-6">
                      ...
                      <div id="cont-estadocreditogrupal2" <?php echo $prestamocredito->idprestamo_estadocredito==2?'style="display: none;"':'' ?>>
              ...
              <div id="tab-detalle-cliente-4" class="tab-content" style="display: none;">
...
<script>
  ...
  @if(configuracion($tienda->id,'prestamo_tipocredito')['resultado']=='CORRECTO')
    ...
    }).val('{{$prestamocredito->tipocredito}}').trigger("change");
  @endif
  ...
  $('#idcliente').select2({
        ...
        $.ajax({
            ...
            type:'GET',
            data: {
                idcliente : {{$prestamocredito->idcliente}}
            },
  ...
  @if($prestamocredito->idprestamo_frecuencia!=0)
...
<!--script>
    ...
    function expediente_index(){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamosolicitud/{{ $prestamocredito->id }}/edit?view=expediente',result:'#cont-expediente'});
    }
    ...
    function expedientedetalle_editar(idcredito){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamosolicitud/'+idcredito+'/edit?view=expedientedetalleeditar',result:'#cont-expedientedetalle'});
    }
</script-->     
<script>
    domicilio_edit();
    ...
    function bien_importar(){
        pagina({route:'{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamosolicitud/{{ $prestamocredito->id }}/edit?view=bienimportar',result:'#cont-bienes'});
    }
