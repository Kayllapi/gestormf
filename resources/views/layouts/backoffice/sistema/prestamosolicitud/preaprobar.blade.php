...
<div id="carga-credito">
    ...
    @if($prestamocredito->fechainiciocero>=Carbon\Carbon::now()->format('Y-m-d'))
            ...
            <div class="mx-modal-cuerpo">
                ...
                <div class="profile-edit-container">
                    <div class="mensaje-warning">
                      ...
                      <b>Fecha de Inicio: {{date_format(date_create($prestamocredito->fechainiciocero),"d/m/Y")}}</b>
                    </div>
                    <form action="javascript:;"
                          onsubmit="callback({
                              route:  'backoffice/tienda/sistema/{{ $tienda->id }}/prestamosolicitud/{{$prestamocredito->id}}',
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{ url('backoffice/tienda/sistema') }}/{{$tienda->id}}/prestamosolicitud/{{$prestamocredito->id}}/edit?view=editar" class="btn mx-btn-post"><i class="fa fa-edit"></i> Modificar Crédito</a>
                            </div>
                            <div class="col-md-6">
                                <button type="submit" class="btn mx-btn-post"><i class="fa fa-check"></i> Preaprobar Crédito</button>
                            </div>
