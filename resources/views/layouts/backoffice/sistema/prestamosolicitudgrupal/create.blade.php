...
@include('app.sistema.cabecera',[
    'nombre' => 'Registrar Solicitud de Crédito Grupal',
    'botones'=>[
    ...
    <form action="javascript:;"
          onsubmit="callback({
                                route:  'backoffice/tienda/sistema/{{ $tienda->id }}/prestamosolicitudgrupal',
                                method: 'POST',
                                data:   {
                                    view: 'registrar',
              ...
              <div id="tab-detalle-cliente-0" class="tab-content" style="display: block;"> 
                <div class="row">
                  <div class="col-sm-6">
                      ...
                      <input type="text" id="nombregrupo" onkeyup="texto_mayucula(this)"/>
                      ...
                      <div class="row">
                          <div class="col-md-4">
                              <label>Monto *</label>
                              <input type="number" id="monto" min="0" step="0.01" disabled/>
    ...
    $('#idcliente').select2({
        ...
        $.ajax({
            ...
            success: function (respuesta){
                ...
                agregarcliente(respuesta['prestamocredito'].id,respuesta['prestamocredito'].idcliente,respuesta['prestamocredito'].clienteapellidomaterno+' '+respuesta['prestamocredito'].clienteapellidopaterno+', '+respuesta['prestamocredito'].clientenombre,respuesta['prestamocredito'].monto)
            }
        })
    });
