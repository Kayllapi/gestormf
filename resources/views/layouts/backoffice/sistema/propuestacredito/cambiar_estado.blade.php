...
<form action="javascript:;" id="form_cambiar_estado">
    ...
    <div class="modal-header">
        <h5 class="modal-title">APROBACIÓN DE CRÉDITO</h5>
        ...
        @if($estado == 'APROBADO')
          ...
          <div class="col-sm-12 col-md-12" id="cont_escalamiento_gate_registrado">
              <div class="alert alert-success mb-0">
                  <i class="fa-solid fa-check"></i>
                  Registro de firma del Asesor(a)/Ejecutivo(a) Proponente: ({{ $asesor->nombrecompleto ?? '' }}) el {{ \Carbon\Carbon::parse($fecha_gate_asesor)->format('d/m/Y H:i') }}.
              </div>
          </div>
          @endif
