<form action="javascript:;" 
    ...
    <div class="modal-header">
        ...
        <button type="button" class="btn-close" id="modal-close-opciones-modificar" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
        <div class="alert alert-danger">
          <i class="fa-solid fa-triangle-exclamation"></i> ¿Esta seguro de modificar?<br>
        </div>
...
<script>
    sistema_select2({ input:'#idresponsable_validacion' });
</script>