...
<div class="list-single-main-wrapper fl-wrap">
    <div class="breadcrumbs gradient-bg fl-wrap">
      ...
      <div class="row">
         <div class="col-md-6">
        @if(modulo($tienda->id,Auth::user()->id,'reportecobranza_listarporcajero')['resultado']=='CORRECTO')
...
function reporte(tipo){
  ...
  load('#iframe-carga'); 
  $('#iframe-tablapdf').html('<iframe onload="iframeload();" src="{{ url('backoffice/tienda/sistema/'.$tienda->id.'/reporte/reporteprestamocobranza/showtablapdf') }}'+
