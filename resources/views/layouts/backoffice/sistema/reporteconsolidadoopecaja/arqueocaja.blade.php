...
<script>
    ...
    function valid_registro_arqueocaja(){
        callback({
            route: '{{ url('backoffice/'.$tienda->id.'/reporteconsolidadoopecaja') }}',
            method: 'POST',
        ...
        function(resultado){
            ...
            modal({ route:"{{url('backoffice/'.$tienda->id.'/reporteconsolidadoopecaja/0/edit?view=valid_registro_arqueocaja')}}",  size: 'modal-sm'  });
        })        
    }
    ...
    function valid_eliminar_arqueocaja(){
        ...
        let url = "{{ url('backoffice/'.$tienda->id) }}/reporteconsolidadoopecaja/0/edit?view=valid_eliminar_arqueocaja&idagencia="+idagencia+"&corte="+corte;
        modal({ route: url,  size: 'modal-sm' })
    }
  
    function reporte_arqueocaja(){
        let idagencia = $('#idagencia').val();
        let url = "{{ url('backoffice/'.$tienda->id) }}/reporteconsolidadoopecaja/0/edit?view=reporte_arqueocaja&idagencia="+idagencia;
        modal({ route: url })
    }
