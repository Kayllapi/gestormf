...
<script>
    ...
    function reporte_arqueocaja_pdf(){
        ...
        $('#iframe_reporte_arqueocaja').attr('src','{{ url('/backoffice/'.$tienda->id.'/reporteconsolidadoopecaja/0/edit?view=reporte_arqueocaja_pdf') }}&fecha_reporte_arqueocaja='+fecha_reporte_arqueocaja+'&idagencia_reporte_arqueocaja='+idagencia_reporte_arqueocaja+'#zoom=90');
    }
</script> 