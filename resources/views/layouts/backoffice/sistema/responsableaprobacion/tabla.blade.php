            ...
            <table class="table table-striped table-hover table-bordered" id="table-creditosnoprendarios">
              <thead class="table-dark">
                ...
                <tr>
                  ...
                  <th style="text-align: center;">AUTONOMÍA DE ADMINITRACIÓN</th>
                  <th style="text-align: center;">AUTONOMÍA DE GERENCIA GENERAL</th>
                  <th style="background-color: #b7b6b78a !important; text-align: center;">ESCALAMIENTO DE APROBACIÓN <br> <span style="color:#c40000 !important;">(Crear para opción 1 y 2)</span></th>
