<form action="javascript:;" 
      onsubmit="callback({
          route: '{{ url('backoffice/'.$tienda->id.'/valorizaciongarantia/'.$tipogarantiadetalle->id) }}',
          method: 'DELETE',
          data:{
              view: 'eliminar'
          }
    ...
    <div class="modal-header">
        <h5 class="modal-title">Eliminar Valorización</h5>
    ...
    <div class="modal-body">
        <div class="alert alert-danger">
          <i class="fa-solid fa-triangle-exclamation"></i> ¿Esta seguro de eliminar la valorización?<br>
          <b>"{{$tipogarantiadetalle->nombre_tipogarantia}}"</b>
        </div>
    </div>
