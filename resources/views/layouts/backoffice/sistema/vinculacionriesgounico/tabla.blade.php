          ...
          <div class="card-body">
            ...
            <table class="table table-striped table-hover" id="table-lista-credito">
              <thead class="table-dark">
                <tr>
                  <th style="text-align: center; border:0.1px solid #5a5a5a;" rowspan="2" colspan="3">VINCULADOS</th>
                  <th style="text-align: center; border:0.1px solid #5a5a5a;" colspan="8">RIESGO Saldo de Créd.(S/.)</th>
                  <th style="text-align: center; border:0.1px solid #5a5a5a;" rowspan="3">TOTAL</th>
                </tr> 
                <tr>
