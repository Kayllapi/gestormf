    ...
    <div class="col-md-9">
        <div class="list-single-main-wrapper fl-wrap">
            <div class="breadcrumbs gradient-bg fl-wrap">
              <span><a href="{{ url($tienda->link) }}" class="mx-href">Inicio</a> <?php echo $menucategorianombre ?></span>
            </div>
        </div>
            ...
            <div class="box-widget-item">
                <div class="list-author-widget-contacts list-item-widget-contacts">
                    <ul>
                        ...
                        ?>
                        @if($check!='todo-los-productos' && $check!='searchtienda')
...
$("#idmarca").select2({
  ...
  if('{{$_GET['marca']}}'!=e.currentTarget.value){
    search_tienda_marca(e.currentTarget.value);
  }
}).val('{{$_GET['marca']}}').trigger("change");
@else
$("#idmarca").select2({
    placeholder: "-- Seleccionar Marca --",
    allowClear: true
...
function search_tienda(categoria,marca,precio){
    ...
    location.href = '{{ url($tienda->link) }}/categoria/'+t_categoria+'?marca='+t_marca+'&precio='+t_precio;
}
</script>
@endsection