...
?>
  @if(isset($facturacionrespuesta))
    @if($facturacionrespuesta->estado=='ACEPTADA')
        ...
        <iframe id="content-ticketpdf" style="display: block" src="{{ url($tienda->link.'/pagina/comprobante/'.$facturacionnotadebito->id.'/edit?view=fnd_ticketpdf') }}#zoom=130" frameborder="0" width="100%" height="600px"></iframe>
        <iframe id="content-a4pdf" style="display: none" src="{{ url($tienda->link.'/pagina/comprobante/'.$facturacionnotadebito->id.'/edit?view=fnd_a4pdf') }}#zoom=130" frameborder="0" width="100%" height="600px"></iframe>
    @else
        ...
        <div class="main-register fl-wrap">
            ...
            <div class="mx-modal-cuerpo" id="contenido-enviarcorreo">
              ...
              <form class="js-validation-signin px-30" 
                  action="javascript:;" 
                  onsubmit="callback({
                    route: '{{ $tienda->link }}/pagina/comprobante/{{ $tienda->id }}',
                    method: 'PUT',
                    carga: '#mx-carga-enviarcorreo',
                    data:{
                        view: 'enviarcorreo-notadebito',
